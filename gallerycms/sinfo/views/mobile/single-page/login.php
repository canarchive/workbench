...
<p style=" text-align:center; margin-top:200px;"><img src="<?= Yii::getAlias('@asseturl'); ?>/cmsad/pc/log_logo.png" width="280" height="72" alt="<?= $this->context->currentSiteInfo['name']; ?>登陆"/></p>
</div>
...
<div style="width:100%; margin:0 auto;">
    <p align="center" style="color:#037C11; font-family: 'Microsoft YaHei Mono', 'Microsoft YaHei UI'">
        <a href="http://wpa.qq.com/msgrd?v=3&uin=2376816784&site=qq&menu=yes" class="lookall" target="_blank"><?= $this->context->currentSiteInfo['name']; ?>  客服QQ：2376816784</a><br />
    </p>
</div>
<script>
var _hmt = _hmt || [];
(function() {
  ...
  hm.src = "//hm.baidu.com/hm.js?6b4b3b0f015994d6c6c3b3b23b2dbc04";
