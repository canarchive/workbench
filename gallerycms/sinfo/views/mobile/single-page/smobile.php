...
<section class="content">
    <div class="top-banner">
        <img src="<?= Yii::getAlias('@asseturl'); ?>/cmsad/mobile/banner/smobile.jpg" alt="手机号抓取"></div>
    <h1>手机号抓取</h1>
        ...
        <div class="m-con">
            <div class="tg-item">
                <div class="tg-item-t">
                    ...
                    <span class='square-l'><em></em></span>手机号抓取
                ...
                <div class="tg-item-det">
                    <div class="tg-item-img">
                        <img src="<?= Yii::getAlias('@asseturl'); ?>/cmsad/mobile/simages/google-ggc-img1.jpg" alt="手机号抓取"></div>
                    <h4>免费体验　只需三步</h4>
                    <p>注册帐户-部署代码 -获取访客</p>
                    <h4>一段神奇的代码，改变了世界</h4>
                    <p>当有访客用手机访问你的移动站时，系统会自动获取访客的手机号码、搜索关键词、地区，等相关访客信息。三网通关、全国首套精准移动客户跟单系统，助您成交率直线上升。</p>
                </div>
            </div>
            <div class="tg-item">
                <div class="tg-item-t">
                ...
                <div class="tg-item-det">
                    ...
                    <h4>抓取率如何？</h4>
                    <p>手机号抓取<b>开通超级接口</b>后大约在<b>15%到20%</b>甚至更多，抓取率主要取决于客户的访问渠道，如果都是使用手机本身流量来访问的话，抓取率会更高。我们说的15%到20%是一个综合对比的概率。<b>建议您免费体验自己测试一下</b>，看看效果。另外QQ号码的抓取率在20%到40%左右，不同漏洞的接口抓取率不一样。</p>
                </div>
            </div>
            <div class="tg-item">
                <div class="tg-item-t">
