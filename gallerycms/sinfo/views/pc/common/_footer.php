    ...
    <div class="container">
        <div class="footer-menu">
            <p id="list" class="list">
                ...
                <a href="/agreement.html">注册协议</a><span>|</span>
                <a href="/sp-register.html">免费体验</a><span>|</span>
                <a href="/sp-login.html">登陆</a>
        ...
        <div class="gzwm">
            <div class="hotLine">在线客服：
                <a href="http://wpa.qq.com/msgrd?v=3&uin=<?= Yii::$app->params['siteQQ']; ?>&site=qq&menu=yes" style="font-size: 14px;">点击咨询</a>
            </div>
            <div class="attention">
