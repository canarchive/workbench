...
<div style="width:100%; margin:0 auto;">
    <p align="center" style="color:#037C11; font-family: 'Microsoft YaHei Mono', 'Microsoft YaHei UI'">
        <a href="http://wpa.qq.com/msgrd?v=3&uin=<?= Yii::$app->params['siteQQ']; ?>&site=qq&menu=yes" class="lookall" target="_blank"><?= $this->context->currentSiteInfo['name']; ?>  客服QQ：<?= Yii::$app->params['siteQQ']; ?></a><br />
    </p>
</div>
</body>
</html>
