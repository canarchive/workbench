...
<div class="topimg-360" style="background:url(<?= Yii::getAlias('@asseturl'); ?>/cmsad/pc/banner/aboutus_qqyuntongji.jpg) no-repeat top center">
    <div class="topimg-con zmail-img pop_zixun">
        <a rel="nofollow" href="/sp-login.html" value="1">立即咨询</a></div>
</div>
<!-- Z云邮部分二 -->
<div class="zyy_item2">
    <div class="zyy_warp">
        ...
        <div class="zyy_it2_right">
            <img src="<?= Yii::getAlias('@asseturl'); ?>/cmsad/pc/simg/zmail-pic1.png" alt="一段神奇的代码、改变了世界" /></div>
    </div>
</div>
<div class="zyy_item3">
    <div class="zyy_warp">
        <p class="bg">
            <img src="<?= Yii::getAlias('@asseturl'); ?>/cmsad/pc/simg/zmail-pic2_bg.png" alt="软件介绍" /></p>
        <div class="zyy_title">
            <h2></h2>
            <p></p>
        </div>
        <div class="zyy_it3_left">
            <img src="<?= Yii::getAlias('@asseturl'); ?>/cmsad/pc/simg/zmail-pic2.png" alt="软件介绍" /></div>
...
<div class="zyy_item4">
    <div class="zyy_warp zyy_warp1">
        ...
        <div class="zyy_it4_right">
            <img src="<?= Yii::getAlias('@asseturl'); ?>/cmsad/pc/simg/zmail-pic3.png" alt="你能获得什么" /></div>
    </div>
