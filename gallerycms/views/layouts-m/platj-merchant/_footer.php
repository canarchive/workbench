...
<footer class="copyRight">
    <p class="copy-1">
        <a href='<?= "/{$this->context->currentCityCode}/"; ?>'>首页</a><i></i>
        ...
        <a href='/desc.html' class="wy_download" id="downLoad" rel="nofollow">关于我们</a><i></i>
        <a href='/' class="wy_download" id="downLoad" rel="nofollow">选择城市</a>
    </p>
    <p class="copy-2">
        <span>
