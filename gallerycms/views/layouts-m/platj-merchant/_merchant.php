...
<section class="ziXun">
    ...
    <a href="<?= "/{$this->context->currentCityCode}/merchant/"; ?>" title="查看更多装修公司" style="font-size:12px;color:#62c77b;text-align: center;width: 100%;display:block; height:40px; line-height:40px; margin:auto;">查看更多装修公司
