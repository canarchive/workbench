<div class="fr cont_right">
    ...
    <?= $this->render('_right-merchant'); ?>
    <?php echo $this->render('_right-quote'); ?>
    <?= $this->render('_right-ask'); ?>
    <?php //echo $this->render('_right-recommend'); ?>
    <?php //echo $this->render('_right-ad-pic'); ?>
</div>
<?php //echo $this->render('@gallerycms/views/layouts/platj/_right-webcall'); ?>
