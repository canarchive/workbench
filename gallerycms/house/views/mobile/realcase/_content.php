    ...
    <section class="Ruogu_jiaM1 clearfix">
        ...
        <div class="fr ruodetail2">
            <div class="clearfix">
                ...
                <div class="phone fr">
                <a class="free" onclick="publish_mess('<?= $info['id']; ?>','realcase', 'realcase-list-design', '免费设计', '')">
                    <span>免费设计</span></a>
                <a class="line" onclick="publish_mess('<?= $info['id']; ?>','realcase', 'realcase-list-quote', '免费报价', '')">
                    <span>免费报价</span></a>
                </div>
            </div>
        </div>
