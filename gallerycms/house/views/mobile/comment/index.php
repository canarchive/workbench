...
<html lang="en-US">
    ...
    <head>
        <meta charset="UTF-8">
        <title>【晨阳水漆】晨阳水漆加盟留言_怎么联系晨阳水漆加盟- 中国加盟网手机端</title>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <meta name="viewport" content="width=device-width,minimum-scale=1.0,maximum-scale=1.0,user-scalable=no">
        <meta name="description" content="手机中国加盟网为您提供最及时的晨阳水漆在线咨询，及时帮您解答相关晨阳水漆加盟问题，为您展示晨阳水漆加盟联系方式，晨阳水漆加盟热线，中国加盟网手机端帮您选择加盟项目,助您创业成功!" />
        <meta name="keywords" content="晨阳水漆加盟留言，晨阳水漆加盟咨询，晨阳水漆加盟热线，晨阳水漆加盟在线咨询 " />
    ...
    <body>
        ...
        <header class="b_header">
            <div class="wrap">
                ...
                <h2 style="width:86%;text-align:center;float:left;font-size:1.2rem;color:#fff;">晨阳水漆在线咨询</h2>
        ...
        <p class="dianP_p">
            ...
            <i>></i>
            <a href="http://m.jmw.com.cn/xm137829/liuyan/" title="晨阳水漆在线咨询">晨阳水漆在线咨询</a></p>
        <section style="width:100%; background:#fff; border-bottom:1px solid #E8EAEE;">
            <ul class="zaixianzixun-example wrap" id="listpage_all">
                <li>
                    ...
                    <ul class="mass-2 fr">
                        ...
                        <li class="mass-2-1">IP：121.17.120.* 留言时间:2017-01-17 15:43:09
                            <img style="width:22px; height:9px;position:absolute;bottom:2px;right:4px;" src="http://60.205.145.0/filesys/spider/pages/asset/platj/img/c91dc-9102.gif" class="fr" /></li>
                ...
                <li>
                    <dl class="mass-1 fl">
                        <dt>
                            <img src="http://60.205.145.0/filesys/spider/pages/asset/platj/img/37112-1012.jpg" alt=""></dt>
            ...
            <form action="" method="post" class="Iwant wrap" id="form_biao">
                <div class="clear">
                    ...
                    <div class="fl you_a">
                        ...
                        <input type="hidden" name="gender" class="fl" value="0" id="message" />
                        <input type="hidden" name="target_id" id="target_id" value="137829">
                        <input type="hidden" value="13" name="origin" id="origin">
                ...
                <p class="current9">
                    <a onclick="return checkMessageInfo_new_bx();">提交留言</a></p>
                ...
                <p class="fl" style="width:90%;font-size:12px;padding-left:0;">已有<i style="color:#e43c01;"></i>人想去<span style="color: #E43C01;font-weight: bold;line-height:20px">第九届中国品牌加盟投资博览会-北京国家会议中心</span>现场看<span style="color: #E43C01;font-weight: bold;">晨阳水漆</span>创业项目(<i style="color:#e43c01;">我也想去</i>)</p></div>-->
        ...
        <script>function checkMessageInfo_new_bx() {
