...
<div class="container" data-page="gujia">
    ...
    <div id="share-msg" class="bdsharebuttonbox bdshare-button-style0-32">
        <ul class="clearfix">
            <li data-cmd="sqq">
                <img data-cmd="sqq" src="http://s2.17house.com/common_h5/images/qq.png">
                <p data-cmd="sqq">QQ</p></li>
            <li data-cmd="qzone">
                <img data-cmd="qzone" src="http://s1.17house.com/common_h5/images/qzone.png">
                <p data-cmd="qzone">空间</p></li>
            <li data-cmd="tsina">
                <img data-cmd="tsina" src="http://s1.17house.com/common_h5/images/weibo.png">
                <p>微博</p>
            </li>
            <li data-cmd="renren">
                <img data-cmd="renren" src="http://s1.17house.com/common_h5/images/renren.png">
                <p>人人</p>
            </li>
        </ul>
    ...
    <div class="concl-banner">
        <img class="img100" src="http://s2.17house.com/common_h5/images/calc-banner.jpg">
        <div class="con-wrap">
            <div class="ban-tit">
        ...
        <div class="taocan">
            <div class="txt-box">
                <a href="http://m.beijing.17zhuangxiu.com/zhengzhuang/">
                    <img src="http://s1.17house.com//msite/images/taocan677.jpg" alt="677元/平米整装套餐" class="img34">
                    <div class="tao-txt">
        ...
        <div class="taocan ">
            <div class="txt-box">
                <a href="http://m.beijing.17zhuangxiu.com/zhucai/">
                    <img src="http://s1.17house.com/msite/images/taocan377.jpg" alt="377元/平米主材套餐" class="img34" style="margin-top:0; margin-bottom: 5%;">
                    <div class="tao-txt">
                        <p class="p1 text-right  f18 ellipsis">
...
<!--页脚 end-->
<!--<script type="text/javascript" src="http://www.178.com/s/js/1.8.3.js"></script>-->
<script data-main="http://s1.17house.com/mznbj/js/decorationMain.js?v=2016053101" src="http://s1.17house.com/mznbj/js/plugin/require.js?v=2016053101"></script>
