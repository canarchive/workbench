...
<div id="listPage">
    ...
    <section class="Ruogu_jiaM1 clearfix">
        ...
        <div class="fr ruodetail2">
            <div class="clearfix">
                <ul class="ul1 fl">
                    <a id="font" class="a1" href="<?= "/{$this->context->currentCityCode}/workingshow_{$info['id']}.html"; ?>" title="<?= $info['name']; ?>"><?= $info['name']; ?></a>
                    <a href="javascript:void(0);">
                        <li>户型：<?= $info['ownerInfo']['house_type']; ?></li></a>
                    <?php if (!empty($info['style'])) { ?>
                    <a href="javascript:void(0);">
                        <li>风格：<?= $info->styleInfos[$info->style]; ?></li></a>
                    <?php } ?>
                    <a href="javascript:void(0);">
                        <li>面积：<?= $info['ownerInfo']['area']; ?></li></a>
                </ul>
                <div class="phone fr">
                <a class="free" onclick="publish_mess('<?= $info['id']; ?>','working', 'working-list-design', '免费设计', '')">
                    <span>免费设计</span></a>
                <a class="line" onclick="publish_mess('<?= $info['id']; ?>','working', 'working-list-quote', '免费报价', '')">
                    <span>免费报价</span></a>
                </div>
            </div>
        </div>
