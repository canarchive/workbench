...
<div id="listPage">
    <div class="title_span clear">
        <span class="fl titleL">
            <a href="<?= "/{$this->context->currentCityCode}/merchant/"; ?>" title="<?= $this->context->currentCityName . '装修公司'; ?>"><?= $this->context->currentCityName . '装修公司'; ?></a></span>
        <span class="fr titleR">
            <u></u><a href="<?= "/{$this->context->currentCityCode}/merchant/"; ?>" title="<?= $this->context->currentCityName . '装修公司'; ?>">更多</a></span>
    </div>
    ...
    <section class="Ruogu_jiaM1 clear">
        <div class="fl ruodetail">
            <dl>
                ...
                <dd>
                    <input type="hidden" class="ajaxGetNumById" value="6584328" />已服务业主:
                    <a href="javascript:;" class="apCountNumClass" id="apCountNum6584328">
                        <span><?= $info['num_owner']; ?></span></a>
                </dd>
            </dl>
        </div>
        <div class="fr ruodetail2">
            ...
            <!--<ul class="ul2 clear"><li class='li6'></li><li class='li7'></li></ul>-->
        </div>
    </section>
    <?php } ?>
</div>
