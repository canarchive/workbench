...
<div class="header">
    ...
    <div class="header_center">
        <div class="header_center_container">
            <div class="header_center_main">
                <span class="hcc_logo">
                    <a href="http://www.to8to.com" class="logo" id="logourl">土巴兔装修网</a></span>
                ...
                <div class="index_banner_s">
                    ...
                    <ul id="side_slider" class="banner_slider" style="left:-230px">
                        <li>
                            <a href="http://www.to8to.com/zb/" class="nav_fzlink" target="_blank" rel="nofollow">
                                <img src="http://img.to8to.com/decorate_gallery/images/confirm/index_banner_sider5.jpg?20141103" width="230" height="70" alt="全程免费服务"></a>
                        </li>
                        <li class="on">
                            <a href="http://www.to8to.com/company/zxb.php" target="_blank" rel="nofollow">
                                <img src="http://img.to8to.com/decorate_gallery/images/confirm/index_banner_sider1.jpg?20141103" width="230" height="70" alt="装修保"></a>
                        </li>
                        <li>
                            <a href="http://www.to8to.com/zb/" class="nav_fzlink" target="_blank" rel="nofollow">
                                <img src="http://img.to8to.com/decorate_gallery/images/confirm/index_banner_sider2.jpg?20141103" width="230" height="70" alt="全国装修门户"></a>
                        </li>
                        <li>
                            <a href="http://www.to8to.com/zb/" class="nav_fzlink" target="_blank" rel="nofollow">
                                <img src="http://img.to8to.com/decorate_gallery/images/confirm/index_banner_sider3.jpg?20141103" width="230" height="70" alt="装修行业领导者"></a>
                        </li>
                        <li>
                            <a href="http://www.to8to.com/zb/" class="nav_fzlink" target="_blank" rel="nofollow">
                                <img src="http://img.to8to.com/decorate_gallery/images/confirm/index_banner_sider4.jpg?20141103" width="230" height="70" alt="740万业主推荐"></a>
                        </li>
                        <li>
                            <a href="http://www.to8to.com/zb/" class="nav_fzlink" target="_blank" rel="nofollow">
                                <img src="http://img.to8to.com/decorate_gallery/images/confirm/index_banner_sider5.jpg?20141103" width="230" height="70" alt="全程免费服务"></a>
    ...
    <div class="header_bottom">
        <div class="header_menu">
            <ul>
                <li>
                    <a class="nav_fzlink" href="http://www.to8to.com/">首页</a>
                    <b>
                    </b>
                </li>
                <li class="has_secondMenu">
                    <a href="http://xiaoguotu.to8to.com/">
                        <em class="menu_arrow"></em>
                        <span>效果图</span></a>
                    <dl>
                        <dd>
                            <a href="http://xiaoguotu.to8to.com/meitu/">家居美图</a>
                            <a href="http://xiaoguotu.to8to.com/tuce/">家居图册</a>
                            <a href="http://xiaoguotu.to8to.com/topic/">精品专题</a></dd>
                    </dl>
                    <b>
                    </b>
                </li>
                <li class="has_secondMenu ">
                    <a href="http://www.to8to.com/gonglve/">
                        <em class="menu_arrow"></em>
                        <span>装修攻略</span></a>
                    <dl>
                        <dd>
                            <a href="http://www.to8to.com/riji/">装修日记</a>
                            <a href="http://www.to8to.com/yezhu/">学装修</a>
                            <a href="http://www.to8to.com/ask/">问答</a>
                            <a class="nav_fzlink" id="nevzwjurl" href="http://www.to8to.com/zwj/">找我家</a></dd>
                    </dl>
                    <b>
                    </b>
                </li>
                ...
                <li class="">
                    <a class="nav_fzlink" href="http://www.to8to.com/company/">装修公司</a>
                    <b>
                    </b>
                </li>
                <li class="has_homeIcon">
                    <a href="http://mall.to8to.com/">特卖商城</a>
                    <b>
                    </b>
                </li>
            </ul>
            <a href="http://www.to8to.com/apps/" class="q_code" rel="nofollow">
                <div class="q_code_layer">
                    ...
                    <span class="qcode_title">关注土巴兔微信</span>
...
<script src="http://www.to8to.com/gb_js/user_login.js" type="text/javascript"></script>
<script src="http://www.to8to.com/gb_js/common_new_forold.js?222" type="text/javascript"></script>
<script src="/get_city_name.php" type="text/javascript"></script>
...
<script type="text/javascript">var jq = jQuery.noConflict();
    ...
    if (url == '?act=gs_jj') {
        jq("#about_t8t").removeClass("about_t8t");
        jq("#gs_jj").addClass("about_t8t");
    }
        ...
        <div class="footer_bottom_container">
            <div class="fbc_menu">
                <ul>
                    ...
                    <li>
                        <a hidefocus="" href="http://www.to8to.com/about/feedback.php" target="_blank" rel="nofollow">意见反馈</a>
                        <span></span>
                    </li>
                    <li>
            ...
            <div class="fbc_icpico">
                <a href="http://szcert.ebs.org.cn/d6c3aa01-b00f-4d32-aef4-70ad63021bab" target="_blank" rel="nofollow">
                ...
                <a rel="nofollow" target="_blank" href="https://search.szfw.org/cert/l/CX20140929005207005275">
