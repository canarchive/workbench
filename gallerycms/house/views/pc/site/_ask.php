...
<div class="daQuan_JM clear">
    <ul class="hot_JM clear">
        ...
        <li class="fl hotHover_li li<?= $liClass; ?>"><a href='/ask/lm-<?= $sort; ?>/'><?= $info['name']; ?></a></li>
    ...
    <div class="Manycon_JM clear">
        ...
        <li class="fl"><a href="<?= "/ask/show-{$sInfo['id']}.html"; ?>" class="fl" title="<?= $sInfo['name']; ?>"><?= $sInfo['name']; ?></a> <span class="fr f12"><?= $sInfo['num_answer']; ?>人回答</span></li>
        <?php } ?>
        </ul></div></div>
        <?php } ?>
    </div>
