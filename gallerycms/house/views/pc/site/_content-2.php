            ...
            <ul>
                <li>
                    <a href="http://www.jmw.com.cn/xm79341/" target="_blank" title="樱花涂料加盟">
                        <img src="<?= Yii::getAlias('@asseturl'); ?>/house/platj/img/39ba3-3653.jpg" alt="樱花涂料加盟"></a>
                ...
                <li>
                    <a href="http://www.jmw.com.cn/xm58277/" target="_blank" title="德尔地板加盟">
                        <img src="<?= Yii::getAlias('@asseturl'); ?>/house/platj/img/7a387-3426.jpg" alt="德尔地板加盟"></a>
                    ...
                    <span id="advert" style="height: 13px;width: 24px;position: absolute;top: 0;right: 0; overflow:hidden;">
                        <a href="http://www.jmw.com.cn/xm58277/">
                            <img src="<?= Yii::getAlias('@asseturl'); ?>/house/platj/img/4cc6f-7890.png" style="float: left; width: auto;height: auto;" alt="德尔地板加盟">德尔地板加盟</a></span>
                </li>
                <li>
                    <a href="http://www.jmw.com.cn/xm6582517/" target="_blank" title="定荣家轻钢别墅加盟">
                        <img src="<?= Yii::getAlias('@asseturl'); ?>/house/platj/img/3f014-4867.jpg" alt="定荣家轻钢别墅"></a>
                    ...
                    <span id="advert" style="height: 13px;width: 24px;position: absolute;top: 0;right: 0; overflow:hidden;">
                        <a href="http://www.jmw.com.cn/xm6582517/">
                            <img src="<?= Yii::getAlias('@asseturl'); ?>/house/platj/img/4cc6f-7890.png" style="float: left; width: auto;height: auto;" alt="定荣家轻钢别墅">定荣家轻钢别墅加盟</a></span>
                </li>
                <li style='margin-right:0px;'>
                    <a href="http://www.jmw.com.cn/xm6589649/" target="_blank" title="空间美贝壳粉生态涂料加盟">
                        <img src="<?= Yii::getAlias('@asseturl'); ?>/house/platj/img/aee91-3907.jpg" alt="空间美贝壳粉生态涂料加盟"></a>
                    ...
                    <span id="advert" style="height: 13px;width: 24px;position: absolute;top: 0;right: 0; overflow:hidden;">
                        <a href="http://www.jmw.com.cn/xm6589649/">
                            <img src="<?= Yii::getAlias('@asseturl'); ?>/house/platj/img/4cc6f-7890.png" style="float: left; width: auto;height: auto;" alt="空间美贝壳粉生态涂料加盟">空间美贝壳粉生态涂料加盟</a></span>
                </li>
            </ul>
        </div>
    </div>
