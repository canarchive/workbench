        ...
        <div class="chart_list clearfix">
            ...
            <dl class="dl_none">
                ...
                <dd class="dd4 clearfix">
                    <input class="fl quick" type="button" value="免费设计" onclick="message_check('<?= $info['id']; ?>','realcase', 'realcase-list-design','免费设计', '');" />
                    <div class="fl free" onclick="message_check('<?= $info['id']; ?>','realcase', 'realcase-list-quote','免费报价', '');">
                        <span>免费报价</span></div>
                </dd>
            </dl>
            <?php } ?>
