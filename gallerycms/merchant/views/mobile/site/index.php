...
<section class="ziXun">
    <div class="wen_p wrap clear">
        <h2 class="fl" style="border-bottom:none;">
            <a href="http://m.jmw.com.cn/xm137829/bbs/" style="font-size: 16px;color:#e44b46;" title="晨阳水漆创业问答">晨阳水漆创业问答</a></h2>
        <a href="http://m.jmw.com.cn/xm137829/bbs/" title="更多创业问答" class="fr">更多创业问答</a></div>
    <ul class="wrap answer" style="padding-bottom:7px;">
        <li class="clearfix li1" style="height:48px;line-height:48px;">
            <a style="color:#333;" href="http://bbs.jmw.com.cn/thread-46969/1/1.html">现在自己开店好，还是做加盟好...</a>
            <span class="fr">2016-1-26</span></li>
        <li class="clearfix li1" style="height:48px;line-height:48px;">
            <a style="color:#333;" href="http://bbs.jmw.com.cn/thread-46970/1/1.html">加盟费多少？后期有什么扶持？</a>
            <span class="fr">2016-1-26</span></li>
        <li class="clearfix li1" style="height:48px;line-height:48px;">
            <a style="color:#333;" href="http://bbs.jmw.com.cn/thread-46973/1/1.html">赚钱吗？如何才能经营好？</a>
            <span class="fr">2016-1-26</span></li>
    </ul>
</section>
<!-- 创业问答 end-->
...
<section class="ziXun">
    <div class="wen_p wrap clear">
        <h2 class="fl" style="border-bottom:none;">
            <a style="font-size: 16px;color:#e44b46;" href="http://m.jmw.com.cn/xm137829/wangyoudianping/">晨阳水漆网友点评</a></h2>
        <span class="fr">已有
            <a href="http://m.jmw.com.cn/xm137829/wangyoudianping/">29</a>条点评</span></div>
                ...
                <ul class="clear" style="margin-left: 0px;padding-bottom:7px;">
                        ...
                        <div class="pingjia_list">
                            <dl class="pingjia_dl clear">
                                ...
                                <dd>
                                    <em class="fl">
                                        <!--意向加盟者-->意向加盟者</em>
                                    <span class="fr">晨阳水漆怎么样?
                                        <i class="xs_5y my_fee4"></i></span>
                                </dd>
                            </dl>
                            <div class="pingjia_1">晨阳水漆后，觉得这个品牌挺不错的，整体感觉不错，很想加盟这个品牌。</div>
                    ...
                    <li>
                        <div class="pingjia_list">
                            ...
                            <div class="pingjia_1">晨阳水漆了解后觉得品牌整体还不错，打算加盟这个品牌</div>
                            <div class="pingjia_2 clear">
                                <p class="fl" onclick="location.href='http://m.jmw.com.cn/m_scoreAction.php?pid=137829'" style="cursor:pointer">
                                    <a href="javascript:;">
                                        <img src="http://60.205.145.0/filesys/spider/pages/asset/platj/m/img/0c91b-9852.png" alt=""></a>
                    ...
                    <li>
                        <div class="pingjia_list">
                            ...
                            <div class="pingjia_1">觉得晨阳水漆有一定的品质，加盟政策了解了一下，迟迟力度还行，想加盟。</div>
                            <div class="pingjia_2 clear">
                                <p class="fl" onclick="location.href='http://m.jmw.com.cn/m_scoreAction.php?pid=137829'" style="cursor:pointer">
                                    <a href="javascript:;">
                                        <img src="http://60.205.145.0/filesys/spider/pages/asset/platj/m/img/0c91b-9852.png" alt=""></a>
                    ...
                    <li>
                        <div class="pingjia_list">
                            ...
                            <div class="pingjia_1">晨阳水漆，在中国加盟网了解后，通过电话咨询了对方，觉得这个品牌总体感觉还是挺不错...</div>
                            <div class="pingjia_2 clear">
                                <p class="fl" onclick="location.href='http://m.jmw.com.cn/m_scoreAction.php?pid=137829'" style="cursor:pointer">
                                    <a href="javascript:;">
                                        <img src="http://60.205.145.0/filesys/spider/pages/asset/platj/m/img/0c91b-9852.png" alt=""></a>
...
<script type='text/javascript'>function hits(obj) {
...
<script type="text/javascript">function DY_scroll(wraper, prev, next, img, speed, or) {
        var wraper = $(wraper);
        var prev = $(prev);
        var next = $(next);
        var img = $(img).find('ul');
...
<section class="ziXun">
    <div class="wen_p wrap clear">
        <h2 class="fl" style="border-bottom:none;">
            <a style="font-size: 16px;color:#e44b46;" href="http://m.jmw.com.cn/xm137829/zixun/">晨阳水漆加盟资讯</a></h2>
        <a href="http://m.jmw.com.cn/xm137829/zixun/" title="更多加盟资讯" class="fr">更多加盟资讯</a></div>
...
<ul class="fr phone">
<li><a style="display:block;width:90%;margin:0 auto;" onclick="$('#Pline_consult1').show();$('.gray_mask').show();$('#kf_content').val('我想咨询晨阳水漆加盟项目，求创业顾问指点！');$('#spd_kf').html('杨老师');$('#kf_origin').val(8);"><span class="a2 fl"></span><i style="font-size: 0.6875em;line-height:32px;">在线咨询</i></a></li></ul>
</div>
<div class="zhiDao wrap clear"> 
<dl class="fl">
...
<ul class="fr phone">
<li><a style="display:block;width:90%;margin:0 auto;" onclick="$('#Pline_consult1').show();$('.gray_mask').show();$('#kf_content').val('我想咨询晨阳水漆加盟项目，求创业顾问指点！');$('#spd_kf').html('苏老师');$('#kf_origin').val(10);"><span class="a2 fl"></span><i style="font-size: 0.6875em;line-height:32px;">在线咨询</i></a></li></ul>
</div>
...
<ul class="fr phone">
<li><a style="display:block;width:90%;margin:0 auto;" onclick="$('#Pline_consult1').show();$('.gray_mask').show();$('#kf_content').val('我想咨询晨阳水漆加盟项目，求创业顾问指点！');$('#spd_kf').html('秦老师');$('#kf_origin').val(11);"><span class="a2 fl"></span><i style="font-size: 0.6875em;line-height:32px;">在线咨询</i></a></li></ul>
</div>
</section>
-->
<!-- 中国加盟网创业指导 end-->
