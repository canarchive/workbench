...
?>
<meta name="image" content="images/@f7405aee-9c85-4489-bbb1-edf36344befc.png" />
<div class="wrap">
    <div class="container about-index">
        <?= $this->render('../common/_breadnav'); ?>
        <div class="row titleimg">
            <img class="img-responsive" src="<?= Yii::getAlias('@asseturl1'); ?>/eale/picbefore/ec6c969b-ca95-4491-82ac-3047e3047a92.png" alt="公司介绍" /></div>
        <div class="row">
