...
<!--<div class="top-header">
    ...
    <ul class="top-wenzi fl">
        <li style="font-size: 0.75em;color:#333;line-height: 1.2rem;">APP</li>
        <li style="font-size: 0.625em;color:#c7c7c7;"></li>
    </ul>
...
<header class="b_header" style="position:relative;">
    <div class="wrap">
        <div class="fl header_1">
            <a rel="nofollow" href="javascript:;" onclick="goBack()" class="icon icon1"></a>
        </div>
        ...
        <div class="fr header_2">
            ...
            <!-- pingbi分享 -->
            <a rel="nofollow" href="javascript:;" title=""></a>
            ...
            <script> 
             ...
             <a href="<?= "/{$this->context->currentCityCode}/"; ?>" title="<?= $this->context->currentCityName . Yii::$app->params['siteNameBase']; ?>" class="icon icon2"></a>
        </div>
    </div>
</header>
