...
$tagNavStr = '与“' . $keyword . '”有关的问答 ' . $pages->totalCount . ' 条';
$this->params['bodyClass'] = 'class="narrow_980"';
?>
<link rel="stylesheet" type="text/css" href="<?= Yii::getAlias('@asseturl'); ?>/house/plat8/css/38284-2423.css">
<script type="text/javascript" src="<?= Yii::getAlias('@asseturl'); ?>/house/plat8/js/ask.js"></script>
<div class="ask_class">
    <?= $this->render('_breadnav', ['tagNavStr' => $tagNavStr, 'isTag' => true]); ?>
                ...
                <ul>
                    ...
                    <li>
                        <div class="question_hd">
                            <a href="/askshow_<?= $info['id']; ?>.html" target="_blank" class="ect">[<?= $sortInfos['sortInfos'][$info['sort']]['name']; ?>]<?= str_replace($keyword, '<em class="ask_word">' . $keyword . '</em>', $info['name']); ?></a>
                        </div>
                        <div class="question_bd ect"><?= str_replace($keyword, '<em class="ask_word">' . $keyword . '</em>', $info['description']); ?></div>
