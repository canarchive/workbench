    ...
    <div class="offerlist-r">
        ...
        <div class="offer-plist list-container">
            ...
            <div class="offer-plist-item clearfix">
                <div class="txtbox">
                    <p class="p1">
                        <a href="/<?= $this->context->currentCityCode . '/quote-show-' . $info['id'] . '.html'; ?>" class="a1" title="<?= $info['name']; ?>"><?= $info['name']; ?></a>
                ...
                <a href="/<?= $this->context->currentCityCode . '/quote-show-' . $info['id'] . '.html'; ?>" class="ata">查看TA的方案</a></div>
            <?php } ?>
            <!-- 右侧列表 end -->
            <!-- 分页 start -->
