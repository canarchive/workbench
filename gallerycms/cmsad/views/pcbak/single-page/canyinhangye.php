...
<html lang="zh-cn">
    ...
    <head>
        ...
        <title>案例故事餐饮行业-中企动力科技股份有限公司</title>
        ...
        <link rel="stylesheet" type="text/css" href="http://s.300.cn/current/home/css/alstory-canyin.css">
    ...
    <body>
        ...
        <div class="section">
            <div class="alstory_main">
                <div class="story-01">
                    <div class="topimg-656" style="background:url(http://s.300.cn/current/home/images/casestory/cs-cy-banner.jpg) no-repeat top center"></div>
                </div>
                <div class="cs-cy cs-cy-part1">
                    <div class="con">
                        <div class="cy-title">
                            <h2 class='title-con'>传统餐饮行业痛点</h2>
                            <div class="title-line title-line1"></div>
                            <div class="title-line title-line2"></div>
                        </div>
                        <div class="cy-questions clearfix">
                            <dl>
                                <dt>
                                    <img src="http://s.300.cn/current/home/images/casestory/case-cy-questions-img1-168.png" alt=""></dt>
                                <dd>菜品信息无法以图文
                                    <br>方式全面展示</dd></dl>
                            <dl>
                                <dt>
                                    <img src="http://s.300.cn/current/home/images/casestory/case-cy-questions-img2-168.png" alt=""></dt>
                                <dd>后台处理订单能力缓
                                    <br>慢，工作效率低</dd></dl>
                            <dl>
                                <dt>
                                    <img src="http://s.300.cn/current/home/images/casestory/case-cy-questions-img3-168.png" alt=""></dt>
                                <dd>无法有效为老客户推
                                    <br>送促销消息</dd></dl>
                            <dl>
                                <dt>
                                    <img src="http://s.300.cn/current/home/images/casestory/case-cy-questions-img4-168.png" alt=""></dt>
                                <dd>餐厅位置难找、地图
                                    <br>位置难定</dd></dl>
                        </div>
                        <div class="cy-ztouchs">
                            <div class="title">Ztouchs完美解决行业痛点</div>
                            <div class="case-show">
                                <div class="multi-tag-end title-sub">
                                    <div>
                                        <strong>多终端</strong>精美展示</div>
                                    <p>环境展示、特色一览、菜品介绍、名师掌勺</p>
                                </div>
                                <div class="client-case-con">
                                    <div class="client-case-tit">客
                                        <br>户
                                        <br>案
                                        <br>例</div>
                                    <div id="slideBox" class="slideBox">
                                        ...
                                        <div class="bd bd-logo">
                                            <ul>
                                                <li>
                                                    <a href="http://www.niurouchuan.net" target="_blank">
                                                        <img src="http://s.300.cn/current/home/images/casestory/cs-cy-case-logo1.jpg"></a>
                                                </li>
                                                <li style='display:none'>
                                                    <a href="http://www.anmicake.com" target="_blank">
                                                        <img src="http://s.300.cn/current/home/images/casestory/cs-cy-case-logo2.jpg"></a>
                                                </li>
                                                <li style='display:none'>
                                                    <a href="http://www.jiakelai.com" target="_blank">
                                                        <img src="http://s.300.cn/current/home/images/casestory/cs-cy-case-logo3.jpg"></a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="bd bd-img">
                                            <ul>
                                                <li>
                                                    <a href="" target="_blank">
                                                        <img src="http://s.300.cn/current/home/images/casestory/cs-cy-caseimg1.png"></a>
                                                </li>
                                                <li style='display:none'>
                                                    <a href="" target="_blank">
                                                        <img src="http://s.300.cn/current/home/images/casestory/cs-cy-caseimg2.png"></a>
                                                </li>
                                                <li style='display:none'>
                                                    <a href="" target="_blank">
                                                        <img src="http://s.300.cn/current/home/images/casestory/cs-cy-caseimg3.png"></a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="taste-btn pop_zixun">
                                        <a href="javascript:void(0);">我要试用</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="cs-cy cs-cy-part2">
                    <div class="con">
                        <div class="view-backstage clearfix">
                            <div class="img floatL">
                                <img src="http://s.300.cn/current/home/images/casestory/cs-cy-backstage.png" alt=""></div>
                            <div class="title floatR">
                                <h2 class='title-con'>方便快捷的可视化
                                    <strong>后台管理系统</strong></h2>
                                <p class='title-sub'>菜单随意换，广告任意修</p>
                                <div class="line title-line1"></div>
                                <div class="line title-line2"></div>
                                <div class="line title-line3"></div>
                            </div>
                        </div>
                        <div class="message-send clearfix">
                            <div class="simple-oprate floatL">
                                <div class="simple-oprate-t">
                                    <strong>一键</strong>操作</div>
                                <ul>
                                    <li>
                                        <span class='dot'></span>一键拨打电话、一键留言</li>
                                    <li>
                                        <span class='dot'></span>一键地图定位、一键分享</li>
                                    <li>
                                        <span class='dot'></span>引导客户进店</li>
                                    <li>
                                        <span class='dot'></span>分享餐厅信息给朋友</li>
                                </ul>
                            </div>
                            <div class="simple-oprate floatL">
                                <div class="simple-oprate-t">消息
                                    <strong>推送</strong></div>
                                <ul>
                                    <li>
                                        <span class='dot'></span>丰富多彩的互动活动</li>
                                    <li>
                                        <span class='dot'></span>引导客户常回家看看</li>
                                </ul>
                            </div>
                            <div class="img floatL">
                                <img src="http://s.300.cn/current/home/images/casestory/cs-cy-message.png" alt=""></div>
                        </div>
                    </div>
                </div>
                <!-- 免费咨询 begin-->
        ...
        <input type="hidden" id="admin_add" name="admin_add" value="70">
        ...
        <script type="text/javascript">$(function() {
                ...
                $('.cs-shop1.cs-zzh .qmw-intro').hover(function() {
                ...
                // 案例展示轮播图
                var slidelen = $('.slideBox .hd li').length;
                var num = 0;
                $('.slideBox .next').on('click',
                function() {
                    num < slidelen - 1 ? num++:num = slidelen - 1;
                    slide(num);
                });

                $('.slideBox .prev').on('click',
                function() {
                    num > 0 ? num--:num = 0;
                    slide(num);
                });
                ...
                function slide(num) {
                    $(".slideBox .hd li").eq(num).addClass('on').siblings('').removeClass('on');
                    $(".slideBox .bd-logo li").eq(num).fadeIn().siblings('').fadeOut();
                    $('.slideBox .bd-img li').eq(num).fadeIn().siblings('').fadeOut();
                }
            });</script>
