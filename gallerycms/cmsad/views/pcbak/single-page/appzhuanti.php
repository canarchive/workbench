...
<html lang="zh-cn">
    ...
    <head>
        ...
        <title>app专题-中企动力科技股份有限公司</title>
        ...
        <link rel="stylesheet" type="text/css" href="http://s.300.cn/current/home/css/appzhuanti.css">
    ...
    <body>
        ...
        <div class="section">
            <div class="app_main">
                <div class="topimg-360" style="background:url(http://s.300.cn/current/home/images/appzhuanti/appzhaunti-banner.jpg) no-repeat top center"></div>
                <div class="appzt-part app-have">
                    <div class="con">
                        <div class="top-title">
                            <div class="title-bd"></div>
                            <h1>
                                <span class='arrow-l'></span>您应该拥有自己的企业APP
                                <span class='arrow-r'></span></h1>
                            <p>对企业来说，开发一款属于自己的APP已刻不容缓</p>
                        </div>
                        <div class="con-inner clearfix">
                            ...
                            <div class="have-l">
                                <div class="have-img">
                                    <img src="http://s.300.cn/current/home/images/appzhuanti/appzhuanti-img1.jpg" alt=""></div>
                                <div class="have-txt">
                                    <div class="have-txt-block">
                                        <span class='have-num'>2</span>
                                        <div class="have-hd">使用手机APP的用户达79%</div>
                                        <p class="have-bd">据宇博智业研究中心了解，每天早上醒来后高达79%的用户会打开手机APP。手机APP已经成为人们的一大日常必需品，越来越多的人从手机APP中获取资讯、娱乐和网上购物。</p></div>
                                </div>
                            </div>
                            <div class="have-r">
                                <div class="have-txt">
                                    <div class="have-txt-block">
                                        <span class='have-num'>1</span>
                                        <div class="have-hd">手机网民规模达6.2亿</div>
                                        <p class="have-bd">据中国互联网信息中心第37次调查报告，截至2015年12月，中国网民规模达6.88亿，互联网普及率为50.3%；手机网民规模6.20亿，占比提升至90.1%。个人上网设备进一步向手机端集中。</p></div>
                                </div>
                                <div class="have-img">
                                    <img src="http://s.300.cn/current/home/images/appzhuanti/appzhuanti-img2.jpg" alt="">
                                    <div class="have-txt">
                                        <div class="have-txt-block">
                                            <span class='have-num'>3</span>
                                            <div class="have-hd">拥有APP的企业达1/3</div>
                                            <p class="have-bd">据不完全统计，目前已有1/3的国内企业定制了自己专属的企业APP，且还在持续增加。国内企业APP定制和应用已快速渗入到零售业、媒体门户、娱乐休闲、生产型企业、政府及事业单位等诸多热门领域。</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="appzt-part app-what">
                    <div class="con">
                        <div class="top-title">
                            <div class="title-bd"></div>
                            <h1>
                                <span class='arrow-l'></span>企业APP能为您带来什么
                                <span class='arrow-r'></span></h1>
                            <p>移动互联网时代，APP营销已成为企业营销工作中不可或缺的手段</p>
                        </div>
                        <div class="con-inner">
                            <div class="what-con">
                                <ul class='clearfix'>
                                    <li>
                                        <div class="what-img">
                                            <img src="http://s.300.cn/current/home/images/appzhuanti/appwhat-list1.png" alt=""></div>
                                        <div class="what-txt">
                                            <h2>精准营销</h2>
                                    ...
                                    <li>
                                        <div class="what-img">
                                            <img src="http://s.300.cn/current/home/images/appzhuanti/appwhat-list2.png" alt=""></div>
                                        <div class="what-txt">
                                            <h2>用户粘性强</h2>
                                    ...
                                    <li>
                                        <div class="what-img">
                                            <img src="http://s.300.cn/current/home/images/appzhuanti/appwhat-list3.png" alt=""></div>
                                        <div class="what-txt">
                                            <h2>成本低</h2>
                                    ...
                                    <li class='last'>
                                        <div class="what-img">
                                            <img src="http://s.300.cn/current/home/images/appzhuanti/appwhat-list4.png" alt=""></div>
                                        <div class="what-txt">
                                            <h2>流量更多</h2>
                                            <p>网络统计数据表明：企业APP带来的客户访问量远远超过了传统互联网（电脑端）的流量，通过企业APP进行盈利也是各行业的发展方向。</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <div class="bottom-zx pop_zixun">
                                <p>想了解更多企业APP的优势</p>
                                <a href="javascript:;" value="1">立即申请</a></div>
                        </div>
                    </div>
                </div>
                <div class="appzt-part app-glxt">
                    <div class="con">
                        <div class="top-title">
                            <div class="title-bd"></div>
                            <h1>
                                <span class='arrow-l'></span>企业APP管理系统
                                <span class='arrow-r'></span></h1>
                            <p>我们专注为各行业提供行之有效的APP管理系统</p>
                        </div>
                        <div class="con-inner">
                            <div class="glxt-con">
                                <h2 class="glxt-tips">企业APP基础功能</h2>
                                <ul class='clearfix'>
                                    <li>
                                        <div class="functions-name">后台管理</div>
                                        <p class='functions-txt'>通过后台可以管理APP所要展示的内容，包括产品管理、资讯管理等方面，做到通过后台实现轻松管理。</p></li>
                                    <li class='last'>
                                        <div class="functions-name">信息推送</div>
                                        <p class='functions-txt'>将最新优惠活动等信息有效精准地覆盖到顾客的移动端APP，达到宣传的目的。</p></li>
                                    <li>
                                        <div class="functions-name">信息分享</div>
                                        <p class='functions-txt'>让顾客通过微博、微信、QQ等方式与朋友分享餐厅的优惠券、活动等信息，进而吸引更多的消费者。</p></li>
                                    <li class='last'>
                                        <div class="functions-name">地图查询</div>
                                        <p class='functions-txt'>通过电子地图，企业的位置一目了然，顾客能方便的查找位置和最佳路线，有效解决顾客的交通难题。</p></li>
                                    <li>
                                        <div class="functions-name">一键拨打</div>
                                        <p class='functions-txt'>通过“一键拨打”功能，与企业客服轻松取得联系，解决了顾客的咨询难题。</p></li>
                                    <li class='last'>
                                        <div class="functions-name">客户留言</div>
                                        <p class='functions-txt'>当顾客心中有疑问想咨询企业，却又不想浪费沟通的电话费时该怎么办？使用“客户留言”，省钱省时又高效。</p></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="bottom-con">
                        <div class="bottom-inner clearfix">
                            <div class="app-android">
                                <img src="http://s.300.cn/current/home/images/appzhuanti/app-android-logo.jpg" alt=""></div>
                            <div class="app-ios">
                                <img src="http://s.300.cn/current/home/images/appzhuanti/app-ios-logo.jpg" alt=""></div>
                            <div class="glxt-tips">IOS、Android，我们都能为您定制</div>
                            <div class="glxt-link">
                                <a id="TQzx0" class="zaixianzixun" clickCount="true" clickAdd="zaixianzixun">免费咨询</a></div>
                        </div>
                    </div>
                </div>
                <div class="appzt-part app-case">
                    <div class="con">
                        <div class="top-title">
                            <div class="title-bd"></div>
                            <h1>
                                <span class='arrow-l'></span>我们的案例
                                <span class='arrow-r'></span></h1>
                        </div>
                        <div class="con-inner">
                            <div class="what-con">
                                <ul class='clearfix'>
                                    <li>
                                        <div class="what-img">
                                            <a href="/case/100616.html" target="_blank">
                                                <img src="http://s.300.cn/current/home/images/appzhuanti/app-case-img1.jpg" alt=""></a>
                                        </div>
                                        <div class="what-txt">工业品/制造业/包装</div></li>
                                    <li>
                                        <div class="what-img">
                                            <a href="/case/102435.html" target="_blank">
                                                <img src="http://s.300.cn/current/home/images/appzhuanti/app-case-img2.jpg" alt=""></a>
                                        </div>
                                        <div class="what-txt">服装行业</div></li>
                                    <li>
                                        <div class="what-img">
                                            <a href="/case/350.html" target="_blank">
                                                <img src="http://s.300.cn/current/home/images/appzhuanti/app-case-img3.jpg" alt=""></a>
                                        </div>
                                        <div class="what-txt">工艺美术</div></li>
                                    <li class='last'>
                                        <div class="what-img">
                                            <a href="/case/96043.html" target="_blank">
                                                <img src="http://s.300.cn/current/home/images/appzhuanti/app-case-img4.jpg" alt=""></a>
                                        </div>
                                        <div class="what-txt">家居建材/百货</div></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <input type="hidden" id="admin_add" name="admin_add" value="17">
