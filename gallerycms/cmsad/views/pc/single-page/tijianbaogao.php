...
<html lang="zh-cn">
    ...
    <head>
        ...
        <title>免费网站体检 - 中企动力科技股份有限公司</title>
        <meta name="keywords" content="网站安全检测，网站体检，漏洞扫描，网络监测，网站故障怎么办，网站被篡改">
        <meta name="description" content="中企动力旗下免费网站体检平台为站长提供7*24小时网站监测和报警服务，功能覆盖网站运行状况、安全性、访问速度、SEO等">
        ...
        <link rel="stylesheet" type="text/css" href="http://s.300.cn/current/home/css/wangzhantijian.css">
    ...
    <body>
        ...
        <div class="section">
            <div class="content">
                ...
                <div class="tijian-result clearfix">
                    <div class="result-left floatL">
                        <div class="left-item">
                            <div class="item-title">网站优化程度</div>
                            <div class="item-con">
                        ...
                        <div class="left-item">
                            <div class="item-title">客户体验友好度</div>
                            <div class="item-con">
                                <div class="star-con clearfix">
                                    <span class="star"></span>
                                    <span class="star"></span>
                                    <span class="star"></span>
                                    <span class="star"></span>
                                    <span class="star-kong"></span>
                                </div>
                            </div>
                        </div>
                        <div class="left-item">
                            <div class="item-title">安全、稳定性</div>
                            <div class="item-con">
                                <div class="star-con clearfix">
                                    <span class="star"></span>
                                    <span class="star"></span>
                        ...
                        <div class="left-item">
                            <div class="item-title">网站访问量</div>
                            <div class="item-con">
                                <div class="star-con clearfix">
                                    <span class="star"></span>
                                    <span class="star"></span>
                    ...
                    <div class="result-right floatR">
                        <div class="right-item web-wenti pt0">
                            <p class="web-address">请输入网站域名：http://www.300.cn</p>
                            <div class="health-index clearfix">
                            ...
                            <div class="web-level">
                                <div class="level">网站等级：
                                    <strong>高级</strong>
                                    <span class="level-index">3</span>暂时没有发现严重问题</div></div>
                        </div>
                        <div class="right-item question-des">
                            <div class="question-des-title">部分问题描述（此处只显示贵网站遇到的前三个问题）</div>
                            <div class="question-des-txt">暂时没有发现严重问题</div></div>
                        <div class="right-item tj-summary">
                            <div class="question-des-title">体检小结：您的网站遇到了一些问题，请您填写下方信息。我们将在两个工作日内为您提供完整版的网站体检报告及解决方案</div>
                                        ...
                                        <div class="con">
                                            <div class="form">
                                                <div class="textfile">
                                                    ...
                                                    <input type="text" name="truename" id="name_bottom" /></div>
                                                <div class="textfile">
                                                    <span class="t">公司</span>
                                                ...
                                                <div class="textfile wherecity wrap">
                                                    ...
                                                    <div class="nice-select marginr gpp" name="nice-select">
                                                        <input type="text" class="gp" value="请选择省份" readonly="" id="gp_bottom" name="province" />
                                                        <ul class="province"></ul>
                                                    </div>
                                                    <div class="nice-select marginr gtt" name="nice-select">
                                                        <input type="text" class="gt" value="请选择城市" readonly="" id="gt_bottom" name="city" />
                                                        <ul class="city"></ul>
                                                    </div>
                                                    <div class="nice-select" name="nice-select">
                                                        <input type="text" class="gd" value="请选择区/县" readonly="" id="gd_bottom" name="district" />
                                                        <ul class="district"></ul>
                                                    </div>
                                                </div>
                                                <div class="textfile clearfix bottom-sub">
                                                    <a class="submit floatL zixunsubmit" value="2">生成体检报告</a>
                                                    <div class="other-ways floatL">
                                                        <div class="other-ways-title">深层次体检咨询</div>
                                                        <div class="othe-way-link">
                                                            <a href="javascript:;" class="ways-tel">400-660-5555</a>
                                                            <span>丨</span>
                                                            <a class="zaixianzixun" id="TQzx0" clickCount="true" clickAdd="zaixianzixun" class="ways-online">售前咨询</a></div>
                                                        <div>
                                                            <a href="/wangzhantijian.html" style="color:#6ca4df;">继续检查其他网站</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <input type="hidden" id="admin_add" name="admin_add" value="22">
