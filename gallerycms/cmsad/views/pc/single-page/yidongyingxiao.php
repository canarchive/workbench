...
<html lang="zh-cn">
    ...
    <head>
        ...
        <title>移动营销服务平台-中企动力科技股份有限公司</title>
        <meta name="keywords" content="移动营销平台、手机广告平台、移动营销、无线营销、微信营销、移动设计营销、互联网+升级、微信互动" />
        <meta name="description" content="中企动力移动营销服务平台,基于强大的技术支持、优质合作伙伴,为企业提供精准的无线营销和品牌网站宣传服务,满足移动营销微信平台搭建及功能应用,提供专业的行业解决方案" />
        ...
        <link rel="stylesheet" type="text/css" href="http://s.300.cn/current/home/css/vone.css">
    ...
    <body>
        ...
        <div class="section">
            <div class="vone_main">
                <div class="topimg-360" style="background:url(http://s.300.cn/current/home/images/vone.jpg) no-repeat top center">
                    <div class="topimg-con vone-img pop_zixun">
                        <a href="javascript:void(0);" value="1">立即咨询</a></div>
                </div>
                <div class="vone-project">
                    <div class="vone-con">
                        <h1>移动圈子4大领域，一个都不能少！</h1>
                        <ul>
                            <li>
                                <i class="icon-p1"></i>
                                <div class="t">微营销</div>
                                <div class="des">绑定微信公众账号
                                    <br />丰富应用，有效吸引关注</div></li>
                            <li>
                                <i class="icon-p2"></i>
                                <div class="t">移动网店</div>
                                <div class="des">商品销售渠道
                                    <br />手机上的网店</div></li>
                            <li>
                                <i class="icon-p3"></i>
                                <div class="t">手机网站</div>
                                <div class="des">品牌形象与产品介绍
                                    <br />手机上的官方网站</div></li>
                            <li>
                                <i class="icon-p4"></i>
                                <div class="t">手机app</div>
                                <div class="des">企业自有营销渠道平台
                                    <br />将客户收入私有领地</div></li>
                            <div class="clear"></div>
                        </ul>
                    </div>
                    ...
                    <div class="vone-con">
                        <div class="zmail-p-con">
                            <div class="img floatR">
                                <img src="http://s.300.cn/current/home/images/vone-pic1.png" alt="界面精美吸引眼球" /></div>
                            <div class="word floatL">
                                <div class="t">
                                    <span>界面精美</span>吸引眼球</div>
                                <div class="con">企业信息、产品、资讯全面展示，让各行业
                                    <br>企业以适合的方式呈现</div></div>
                            <div class="clear"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="vone-con">
                        <div class="zmail-p-con">
                            <div class="img floatL">
                                <img src="http://s.300.cn/current/home/images/vone-pic2.png" alt='流程易用上手快' /></div>
                            <div class="word floatR">
                                <div class="t">
                                    <span>流程易用</span>上手快</div>
                                <div class="con">让客户更快地了解企业，让企业更快地
                                    <br>获取客户</div></div>
                            <div class="clear"></div>
                        </div>
                    </div>
                ...
                <div class="vone-part">
                    <div class="vone-con">
                        <div class="zmail-p-con">
                            <div class="img floatR">
                                <img src="http://s.300.cn/current/home/images/vone-pic3.png" alt="多终端访问无障碍" /></div>
                            <div class="word floatL">
                                <div class="t">
                                    <span>多终端访问</span>无障碍</div>
                                <div class="con">同一个后台，同步管理4大领域，简单易用</div></div>
                            <div class="clear"></div>
                        </div>
                    </div>
                </div>
                <div class="vone-part bg-f5f6fa">
                    <div class="vone-con">
                        <div class="zmail-p-con">
                            <div class="img floatL">
                                <img src="http://s.300.cn/current/home/images/vone-pic4.png" alt=">维护省力成本低" /></div>
                            <div class="word floatR">
                                <div class="t">
                                    <span>维护省力</span>成本低</div>
                                <div class="con">多终端数据整合，信息同步；简单易用，维护省时省力</div></div>
                            <div class="clear"></div>
                        </div>
                    </div>
                </div>
                <div class="vone-part">
                    <div class="vone-con">
                        <div class="zmail-p-con">
                            <div class="img floatR">
                                <img src="http://s.300.cn/current/home/images/vone-pic5.png" alt='随时随地获取更多客户' /></div>
                            <div class="word floatL">
                                <div class="t">
                                    <span>随时随地</span>获取更多客户</div>
                                <div class="con">移动全方位，多入口&nbsp;&nbsp;快速达成意向，达成交易</div></div>
                            <div class="clear"></div>
                        </div>
                    </div>
                </div>
                <div class="dxal">
                    <div class="dxal_con">
                        <div class="t">典型案例</div>
                        <div class="con">已有30000+客户在中企移动营销平台从事移动营销事业</div>
                        <div class="al_slides">
                            <a class="slid_prev"></a>
                            <a class="slid_next"></a>
                            <div class="slid">
                                <ul>
                                    <li>
                                        <img src="http://s.300.cn/current/home/images/vone-al1.jpg" alt='移动营销平台典型案例' />
                                        <div class="al_ewm" style="display:none">
                                            <img src="http://s.300.cn/current/home/images/al-ewm1.jpg"></div>
                                    </li>
                                    <li>
                                        <img src="http://s.300.cn/current/home/images/vone-al2.jpg" alt='移动营销平台典型案例' />
                                        <div class="al_ewm" style="display:none">
                                            <img src="http://s.300.cn/current/home/images/al-ewm2.jpg"></div>
                                    </li>
                                    <li>
                                        <img src="http://s.300.cn/current/home/images/vone-al3.jpg" alt='移动营销平台典型案例' />
                                        <div class="al_ewm" style="display:none">
                                            <img src="http://s.300.cn/current/home/images/al-ewm3.jpg"></div>
                                    </li>
                                    <li>
                                        <img src="http://s.300.cn/current/home/images/vone-al4.jpg" alt='移动营销平台典型案例' />
                                        <div class="al_ewm" style="display:none">
                                            <img src="http://s.300.cn/current/home/images/al-ewm4.jpg"></div>
                                    </li>
                                    <li>
                                        <img src="http://s.300.cn/current/home/images/vone-al5.jpg" alt='移动营销平台典型案例' />
                                        <div class="al_ewm" style="display:none">
                                            <img src="http://s.300.cn/current/home/images/al-ewm5.jpg"></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="zts-server">
                    <div class="zts_con">
                        <h1>服务保障</h1>
                        <h2>覆盖全国范围的服务网络，SLA标准服务承诺，随时随地满足企业服务需求，让企业经营高枕无忧</h2>
                        <div class="con">
                            <ul>
                                <li>
                                    <i class="safe"></i>
                                    <div class="t">安全</div>
                                    <div class="des">病毒杀除率高于99%</div></li>
                                <li>
                                    <i class="stable"></i>
                                    <div class="t">稳定</div>
                                    <div class="des">网站可用性高于99.9%</div></li>
                                <li>
                                    <i class="speed"></i>
                                    <div class="t">极速</div>
                                    <div class="des">5倍赔付中断服务的时间</div></li>
                                <li>
                                    <i class="enough"></i>
                                    <div class="t">周到</div>
                                    <div class="des">覆盖70多个城市，近80家服务网络</div></li>
                                <li>
                                    <i class="intimate"></i>
                                    <div class="t">贴心</div>
                                    <div class="des">全国7×24小时客服热线</div></li>
                                <div class="clear"></div>
                            </ul>
                        </div>
                    </div>
        ...
        <input type="hidden" id="admin_add" name="admin_add" value="65">
        ...
        <script type="text/javascript">$(function() {
                ...
                $(".slid ul").css("width", (count * 230) + "px");
                //初始化给按钮绑定事件
                $(".al_slides a.slid_next").bind("click",
                function() {
                    customerleft();
                });
                $(".al_slides a.slid_prev").bind("click",
                function() {
                    customerright();
                });
                //向左滚动
                function customerleft() {
                    var a_next = $(".al_slides a.slid_next");
                    var ul = $(".slid ul");
                    a_next.unbind("click");
                    var count = $(".slid li").length;
                    var left = ul.position().left;
                    var pleft = left - 230;
                    var aleft = -1 * count * 230 + 920;
                    if (left <= aleft) {
                        ul.animate({
                            right: '10px'
                        },
                ...
                function customerright() {
                    var a_prev = $(".al_slides a.slid_prev");
                    var ul = $(".slid ul");
                    a_prev.unbind("click");
                    var count = $(".slid li").length;
                    var left = ul.position().left;
