...
<html lang="zh-cn">
    ...
    <body>
        ...
        <header>
            <div class="logo">
                <a href="/">
                    <img src="http://s.300.cn/current/mobile/images/logo.png" alt=""></a>
            </div>
            <div class="category">
                <a href="javascript:;"></a>
            </div>
                        ...
                        <div class="container">
                            ...
                            <div class="swiper-container wrap-s" id='wrap-s'>
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="img">
                                            <img src="http://s.300.cn/current/mobile/images/zz-img1.jpg" alt=""></div>
                                        <div class="zz-name">2013年度优秀域名注册服务机构</div></div>
                                    <div class="swiper-slide">
                                        <div class="img">
                                            <img src="http://s.300.cn/current/mobile/images/zz-img2.jpg" alt=""></div>
                                        <div class="zz-name">ZtouchS软件著作权登记证书</div></div>
                                    <div class="swiper-slide">
                                        <div class="img">
                                            <img src="http://s.300.cn/current/mobile/images/zz-img3.jpg" alt=""></div>
                                        <div class="zz-name">质量管理体系认证证书(中文)</div></div>
                                    <div class="swiper-slide">
                                        <div class="img">
                                            <img src="http://s.300.cn/current/mobile/images/zz-img4.jpg" alt=""></div>
                                        <div class="zz-name">Z+软件著作权证书</div></div>
                                    <div class="swiper-slide">
                                        <div class="img">
                                            <img src="http://s.300.cn/current/mobile/images/zz-img5.jpg" alt=""></div>
                                        <div class="zz-name">可信网站明星验证服务中心</div></div>
                                    <div class="swiper-slide">
                                        <div class="img">
                                            <img src="http://s.300.cn/current/mobile/images/zz-img6.jpg" alt=""></div>
                        ...
                        <div class="container">
                            ...
                            <div class="swiper-container wrap-s" id='wrap-s1'>
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="img">
                                            <img src="http://s.300.cn/current/mobile/images/ry-img1.png" alt=""></div>
                                        <div class="zz-name">2015.02|荣获“2014年度最佳最佳创新应用奖”和
                                            <br>“NewgTLD最佳注册服务机构”两项殊荣</div></div>
                                    <div class="swiper-slide">
                                        <div class="img">
                                            <img src="http://s.300.cn/current/mobile/images/ry-img2.png" alt=""></div>
                                        <div class="zz-name">2013.12|“云计算领域平台应用最具影响力企业”</div></div>
                                    <div class="swiper-slide">
                                        <div class="img">
                                            <img src="http://s.300.cn/current/mobile/images/ry-img3.png" alt=""></div>
                                        <div class="zz-name">2012.01 | “2011年度可信网站金牌注册服务机构”
                                            <br>2011年度通用网址金牌注册服务机构”</div></div>
                                    <div class="swiper-slide">
                                        <div class="img">
                                            <img src="http://s.300.cn/current/mobile/images/ry-img4.png" alt=""></div>
                                        <div class="zz-name">Z+2010.05|“中小企业网站建设推荐示范平台”</div></div>
                                    <div class="swiper-slide">
                                        <div class="img">
                                            <img src="http://s.300.cn/current/mobile/images/ry-img5.png" alt=""></div>
                                        <div class="zz-name">2009.05|“2008北京市电子商务诚信十佳企业”
                                            <br>总经理陈丹女士荣获 “2008首都电子商务
                                            <br>‘诚信兴商’十大精英奖”</div></div>
                                    <div class="swiper-slide">
                                        <div class="img">
                                            <img src="http://s.300.cn/current/mobile/images/ry-img6.png" alt=""></div>
