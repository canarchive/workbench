...
$listMenu = isset($menuInfos['menus']['eale_sample_listinfo_' . $sort]) ? $menuInfos['menus']['eale_sample_listinfo_' . $sort] : false;
$addMenu = isset($menuInfos['menus']['eale_sample_add']) ? $menuInfos['menus']['eale_sample_add'] : false;
