...
<html>
    ...
    <head>
        ...
        <title>注册免费订货系统|移动订货|分销订货－易订货｜移动订货系统第１品牌</title>
        <meta name="keywords" content="销售管理系统、分销管理、移动订货、免费客户订货系统、哪个分销系统最好用" />
        ...
        <link rel="stylesheet" href="http://42.96.194.225/filesys/spider/pages/asset/merchant/css/cfe27-5436.css">
        <link rel="stylesheet" href="http://42.96.194.225/filesys/spider/pages/asset/merchant/css/4d799-6142.css" /></head>
    
    <body id="register" style="background: url(http://42.96.194.225/filesys/spider/pages/asset/merchant/img/01884-3245.jpg) no-repeat scroll center center transparent;">
        <div class="header">
        ...
        <div class="container">
            <div class="link-con">
                <a id="registerLink" target="_blank" style="background: url(http://42.96.194.225/filesys/spider/pages/asset/merchant/img/85195-5460.png) center right no-repeat;"></a>
            </div>
            <div class="form-con">
                    ...
                    <form id="step1Form">
                        <div class="control-box">
                            ...
                            <div class="control-form">
                                ...
                                <img src="https://sso.dinghuo123.com/verifyCode" title="点击刷新图片" height="40" width="105" class="auth-image" /></div>
                            <div class="control-form">
                ...
                <div class="r3">
                    ...
                    <div class="r3-content">
                        <div class="r3-l">
                            ...
                            <!-- <p style="margin-top:50px;"><a href="https://www.dinghuo123.com/topics/dingguide.html" target="_blank" ><img src="http://42.96.194.225/filesys/spider/pages/asset/merchant/img/d1988-1579.jpg" alt=""></a></p> --></div>
                        <div class="r3-r">
                            <p class="bqr"></p>
    ...
    <script type="text/javascript" src="http://42.96.194.225/filesys/spider/pages/asset/merchant/js/jquery.combo.js"></script>
    ...
    <script type="text/javascript" src="http://42.96.194.225/filesys/spider/pages/asset/merchant/js/dialog-min.js"></script>
    <script type="text/javascript" src="http://42.96.194.225/filesys/spider/pages/asset/merchant/js/dialog-plus-min.js"></script>
            ...
            THISPAGE = {
                init: function() {
                    ...
                    function(value, element) {
                        ...
                        data = {
                            "userName": inputElem.val()
                        },
                        flag = true;
                        $.ajax({
                            type: "POST",
                            url: "/ajaxChecking?action=checkUserNameExist",
                            dataType: "json",
                            data: data,
                            async: false,
				...
				$('#registerLink').addClass('animated fadeInLeft');
                    ...
                    $("#getVerifyBtn").click(function(e) {
                        ...
                        var postData = {
                            ...
                            verfCode: $.trim($("input[name=verfCode]").val())
                        };
                        if (step1FormValid) {
