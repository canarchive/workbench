...
<form id="myForm" action="/app/login" method="post"> 
    <section> 
     ...
     <input type="hidden" name="service" value="ydh-agent" /> 
     <input type="hidden" name="relayState" value="/app/index.jsp" /> 
     ...
     <div class="writeBox"> 
        ...
        <div class="verifyCode-box bb" style="display:none;" "=""> 
         <img src="/verifyCode" alt="验证码" title="点击刷新" class="verifyCodeImg" /> 
         <i class="ic ic_3"></i> 
...
<script type="text/javascript" src="js/common.js?v=20151126"></script> 
<script>
// 设置链接的margin-top值
function setLinkPos() {
