...
?>
<link rel="shortcut icon" href="http://www.yuezw.com/favicon.ico" />

<script>
var isMobile = '<?= intval($this->context->isMobile); ?>';
if (isMobile == 1) {
    window.location.href = "<?= Yii::getAlias(Yii::$app->params['hostAliasMobile']) . Url::to(['/decoration/detail/feature', 'view' => 'yzwbj', 'city_code' => Yii::$app->params['currentCompany']['code_short']]); ?>";
}
</script>
<script>
var _hmt = _hmt || [];
(function() {
	  var hm = document.createElement("script");
	    hm.src = "https://hm.baidu.com/hm.js?cfa757288291d057d7ffe3886128d8d4";
    ...
    <div class="wrap">
        <div class="jia_logo clearfix fl" style="padding-top: 0px;">
            <div class="logo fl" style="padding-top: 10px;">
                ...
                <img width="121" height="75" alt="<?= Yii::$app->params['siteNameBase']; ?>网首页" src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/third/pc_logo1.png"></a>
            </div>
            <div class="fl" style="position: relative;">
                <a href="javascript:;" class="major_pop" tjjj="click_pc_logo.right.link" tjjj_name="暖暖的新家logo">
                <img width="128" height="94" src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/third/pc_logo2.png" style="display: block;"></a>
            </div>
        </div>
        ...
        <div class="topm_among">
            <div class="big_graph">
                <a href="javascript:;" class="major_pop" tjjj="click_pc_top_nndxj" tjjj_name="暖暖的新家">
                    <img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/third/pc_banner.jpg" /></a>
            </div>
...
<div class="company_list">
                ...
                <div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides clearfix" style="width: 2000%; transition-duration: 0s; transform: translate3d(0px, 0px, 0px);">
                            ...
                            <a href="javascript:;" class="major_pop" shop_id="5124263" tjjj="click_pc_3F_logo_2" tjjj_name="泰峰装饰"><img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/sj/images/yuezw.jpg" draggable="false"></a>
                            <div class="message_r">
                                <a href="javascript:;" class="major_pop" tjjj="click_pc_3F_name_2" shop_id="5124263" title="泰峰装饰" tjjj_name="泰峰装饰">悦装网</a>
                                <span>案例：398个</span>
                                <span>评论：1854条</span>
                                <span>口碑值：1231</span>
                            </div>
...
<input type="hidden" id="return_url" value="http://www.yuezw.com/" />
<div id="jia_footer">
    <div class="jia_foot_info">
        <p>Copyright@2015 北京悦装互联网科技有限公司 版权所有</p>
        <p>京ICP备16004340号</p>
    </div>
</div>
