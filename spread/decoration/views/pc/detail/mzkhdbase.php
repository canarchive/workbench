    ...
    <div class="tuiguang_top1">
         <div class="tg_top1_left">
            ...
            <!--    required oninvalid="setCustomValidity('请填写正确手机号！')" oninput="setCustomValidity('')" -->
                        ...
                        <input type="submit" id="submit1" value="立即预约" class="ljshengqing">
                     <div id="shibai1"></div>
                     <div id="shurub1"></div>
                     <div id="shuruxm1"></div>
                </form>
            ...
            <script >
            function mySubmit(mark){
    var name = mark == '1' || mark == '2' ? $('#user_name' + mark).val() : '';
    var tel = $('#user_phone' + mark).val();
    var $data = {
        name: name,
        mobile: tel,
    };
...
<!-- top5 start -->
 <div class="tuiguang_top5">
        ...
        <div class="indextc">
        <ul class="on_tc">
            <li class="btr_la"><img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/mzk/pc/images/picv2_index_taoc01.jpg" alt="www.imeizhaike.com-美宅客" class="lazy">
            ...
            <li class="indextcr"><img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/mzk/pc/images/picv2_index_taoc02.jpg" alt="www.imeizhaike.com-美宅客" class="lazy">
            ...
            <li class="btr_lb"><img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/mzk/pc/images/picv2_index_taoc03.jpg" alt="www.imeizhaike.com-美宅客" class="lazy">
...
<div class="tijiao_diz">
    ...
    <div>
    <!-- required oninvalid="setCustomValidity('请填写正确手机号！')" oninput="setCustomValidity('')" -->
 <form  name="mobileform" id="myForm3"> 
    <input name="mobile" id="user_phone3" type="text" maxLength="11" placeholder="请输入您的手机号">
    <input name="B1" type="submit"  id="submit3" value="发送地址到手机" id="label3" class="ljshengqing">
 </form><div id="shibai"></div>
        <div id="shurub"></div>
    </div>
</div>
<script>
            function mySubmit3(flag){
                    return flag;            
            }
            $(document).ready(function(){
...
<div id="tb_gg"><img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/mzk/pc/images/thb_03.jpg" width="899" height="499" class="on_tc"><i><img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/mzk/pc/images/pic_mzktg1_055.png" width="35" height="35"></i></div>
<!--footer-->
<div class="footer">
    <div class="middle">              
...
<div class="chenggong_yy">
    ...
    <i class="iconfont guanbitc">&#xe60a;</i>
        ...
        <div class="fwuh">
            <img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/mzk/pc/images/ewm.png" width="280" height="280">
            <p>获取最新优惠信息，<br>
            请关注微信服务号</p>
        </div>
    </div>
...
<div id="shibaile">
 <div class="chenggong_yy">
    ...
    <i class="iconfont guanbitc">&#xe60a;</i>
        ...
        <span>您可以通过以下渠道预约：</span>
        </div>
    </div>
    
    <div class="dc_ya dc_left">
           <img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/mzk/pc/images/yuyueshibai_03.jpg" width="149" height="151"> 
        <span>重新预约</span>
        </div>
        <div class="dc_ya dc_center">
        <img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/mzk/pc/images/yuyueshibai_05.jpg" width="149" height="151"> 
        <span>也可以关注微信服务号，<br>在微信服务号预约；</span>
        </div>
        <div class="dc_ya dc_right">
        <img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/mzk/pc/images/yuyueshibai_07.jpg" width="149" height="151"> 
        <span>致电美宅客全国统一服务热线 <br>400-8118-088</span>
        </div>
     </div>
  </div>     
<!-- 预约失败弹出-->
    ...
    <div class="indexqg index_xgg">
        ...
        <div class="indexqg_fr">
            ...
            <p class="indexqg_frxm">
               <!-- <input name="user_name" type="text" placeholder="您的姓名" required oninvalid="setCustomValidity('请填写您的姓名')">-->
                <input name="user_name" type="text" id="user_name2" placeholder="姓名">
            </p>
            <p class="indexqg_frxm">
                <input name="user_tel" type="text"  id="user_phone2" maxLength="11" placeholder="您的手机号码" oninput="setCustomValidity('')">
            </p>
            <input type="hidden" name="act" value="">
            <input type="hidden" name="msg_type" value="6">
            <input type="submit" value="预约" style="display:none" id="msgsubmit2">
            <a onclick="$('#msgsubmit2').click();" class="indexqg_fran">立即预约</a>
            </form>
            <div id="shibai2"></div>
            <div id="shurub2"></div>
            <div id="shuruxm2"></div>
        ...
        <script>
            function mySubmit2(flag){
                    return flag;            
            }
            $(document).ready(function(){
                    
                    var name_flag2 = false;
                    var phone_flag2 = false;
                ...
                var user_phone1 = $('#user_phone2').val();    
                if(user_phone1!=""){
                $("#shurub2").hide(); 
                }
                ...
                $("#msgsubmit2").click(function(){
                    ...
                    var user_phone =$('#user_phone2').val();
                    if(user_phone==""){
                        $('#shurub2').show();
                         phone_flag2= false;
                    }
...
<script>
 ...
 $("#chengggle .guanbitc").click(function(){
    $("#chengggle").hide();
  });
   $("#shibaile .guanbitc").click(function(){
    $("#shibaile").hide();
  });
</script>
...
<input type="hidden" id="return_url" value="http://www.imeizhaike.com/success.html" />
