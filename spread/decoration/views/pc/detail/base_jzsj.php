...
<link href="<?= Yii::getAlias('@asseturl'); ?>/spread/house/collect/css/5166c-3271.css" rel="stylesheet" type="text/css" />
<link href="<?= Yii::getAlias('@asseturl'); ?>/spread/house/collect/css/64701-9059.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/collect/js/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/collect/js/common.js"></script>
...
<div class="login_popup">
    <div class="main_content log_form">
        <ul>
            <li>
                <em>用户名：</em>
                <input value="" placeholder="请输入登录手机号/邮箱" name="loginName" type="text"></li>
            <li>
                <em>密码：</em>
                <input placeholder="请输入密码" name="loginPwd" type="password"></li>
        </ul>
        <p class="small_tip">
            <input checked="checked" type="checkbox">
            <span>记住我</span>
            <a href="http://user.jiazhuang.com/findpwd/">忘记登录密码？</a></p>
        <p class="loading_sub">
            <input id="loginBtn" value="登录" type="button"></p>
        <p style="width:406px; text-align:center; line-height: 35px">
            <a href="http://user.jiazhuang.com/register" rel="nofollow">还没有账号？立即注册</a></p>
    </div>
</div>
        ...
        <div class="container clearfix">
            ...
            <div class="bottom_sjybj_center cl">
                ...
                <div class="bottom_sjybj_right">
                    <div class="sjybj_txt">我可以做您的家装顾问</div>
