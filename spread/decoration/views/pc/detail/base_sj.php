        ...
        <div class="topm_among">
            <div class="big_graph">
                <a href="javascript:;" class="major_pop" tjjj="click_pc_top_nndxj" tjjj_name="暖暖的新家">
                    <img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/third/pc_banner_<?php if ($currentCode == 'jjjz') { echo 'tbz'; } else { echo $currentCode; } ?>.jpg" /></a>
            </div>
...
<div class="company_list">
                ...
                <?php if (!in_array($currentCode, ['jjjz', 'ypj'])) { ?>
