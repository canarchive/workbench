...
<header class="cWhite cMdGray clearfix">
    <div class="tit_top">
        <div class="left">
            <img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/third/phone_logo.png" alt="">
        </div>
        <div class="f12 text_tit">
            <p>互联网家装领导品牌 更高品质的保障</p>
        </div>
    </div>
</header>
<!-- 正文 start -->
<div class="container" data-page="budget-index">
    <!-- 标题栏 start -->
    <a href="#"><img class="img100" src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/third/phone_banner.jpg" alt=""></a>
