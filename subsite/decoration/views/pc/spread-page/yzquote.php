...
<html>
    ...
    <head>
        ...
        <title>免费申请装修报价_获取4套装修设计方案-优装保装修网</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <meta name="renderer" content="webkit">
        <link rel="Shortcut Icon" href="http://39.106.102.45/filesys/spider/pages/asset/spready/img/4a5b1-5968.png">
        <link rel="stylesheet" href="http://39.106.102.45/filesys/spider/pages/asset/spready/css/31ce5-2348.css" />
        <link href="http://39.106.102.45/filesys/spider/pages/asset/spready/css/a31f0-4841.css" rel="stylesheet" />
        <script src="http://39.106.102.45/filesys/spider/pages/asset/spready/js/jquery-1.11.3.min.js"></script>
        <script src="http://39.106.102.45/filesys/spider/pages/asset/spready/js/offer.js"></script>
        <link rel="stylesheet" href="http://39.106.102.45/filesys/spider/pages/asset/spready/css/30075-1553.css" />
        <link rel="stylesheet" href="http://39.106.102.45/filesys/spider/pages/asset/spready/css/ad67e-1189.css" />
        <style>input::-webkit-input-placeholder { /* placeholder颜色 */ color: #bbb; }</style></head>
    
    <body>
        <!--<script src="http://39.106.102.45/filesys/spider/pages/asset/spready/js/common.js"></script>-->
        <div style="width:1000px;margin: 0 auto;height:65px;">
            <!--<a href="http://www.yzb315.com" target="_blank"><img src="http://39.106.102.45/filesys/spider/pages/asset/spready/img/a9129-1603.png" title="优装保网"></a>-->
            <a href="http://www.yzb315.com" target="_blank">
                <img src="http://39.106.102.45/filesys/spider/pages/asset/spready/img/6a276-3520.png" title="优装保网"></a>
        </div>
        <!-- 首屏 装修计算器 start -->
        <div class="calc-box">
            <img src="http://39.106.102.45/filesys/spider/pages/asset/spready/img/8be71-4953.png" class="calc-img">
            <div class="wbox" style="height: 590px;">
                ...
                <div class="wbox-c">
                    <div class="btnbox">
                        <a class="btn-compute fotBtnCompute">
                            <img src="http://39.106.102.45/filesys/spider/pages/asset/spready/img/0427f-5087.gif" class="btnbox-img" id="btns"></a>
                    </div>
                </div>
                <div class="wbox-r">
                ...
                <div class="Reminder_text" id="Reminder_text">
                    ...
                    <dl>
                        <dt>
                            <img src="http://39.106.102.45/filesys/spider/pages/asset/spready/img/29922-5767.jpg" id="show2weima11" /></dt>
                        <dd>微信扫一扫
                            <br />查看更多装修资讯</dd></dl>
                </div>
                <!--报名后提示文字end--></div>
        ...
        <div class="s_footer">
            <div class="s_footer_content">
                <ul class="footer_head">
                    <li>
                        <img src="http://39.106.102.45/filesys/spider/pages/asset/spready/img/845a3-8507.jpg" alt="" />
                        <h3>专 业 平 台</h3>
                        <p>百万业主 权威保障</p>
                    </li>
                    <li>
                        <img src="http://39.106.102.45/filesys/spider/pages/asset/spready/img/18116-9547.jpg" alt="" />
                        <h3>自 由 比 价</h3>
                        <p>四家公司 自由竞价</p>
                    </li>
                    <li>
                        <img src="http://39.106.102.45/filesys/spider/pages/asset/spready/img/d0b5d-9502.jpg" alt="" />
                        <h3>优 质 服 务</h3>
                        <p>优质客服 全程服务</p>
                    </li>
                    <li>
                        <img src="http://39.106.102.45/filesys/spider/pages/asset/spready/img/ae8a6-7614.jpg" alt="" />
                        <h3>诚 信 商 家</h3>
                        <p>诚信商家 安全保障</p>
                    </li>
                    <li>
                        <img src="http://39.106.102.45/filesys/spider/pages/asset/spready/img/bf0f8-6008.jpg" alt="" />
                        <h3>业 主 监 督</h3>
                        <p>一起消费 集体维权</p>
                    </li>
                    <li>
                        <img src="http://39.106.102.45/filesys/spider/pages/asset/spready/img/d780d-5290.jpg" alt="" />
                        <h3>装 修 保 障</h3>
                        <p>装修保障 立信致远</p>
                    </li>
                </ul>
        ...
        <div class="bottom_nav">
            <div class="bottom_center">
                <img src="http://39.106.102.45/filesys/spider/pages/asset/spready/img/3cd79-8782.png" alt="" class="tp" style=" top: -10px;" />
                <ul>
                    <li>
                ...
                <a href="javascript:void(0)">
                    <img src="http://39.106.102.45/filesys/spider/pages/asset/spready/img/01cc7-2562.png" alt="" /></a>
            </div>
        </div>
        <div class="show">
            <a href="javascript:void(0)">
                <img src="http://39.106.102.45/filesys/spider/pages/asset/spready/img/c84bb-5120.png" alt="" /></a>
        </div>
        <!--悬浮栏end-->
        <link rel="stylesheet" type="text/css" href="http://39.106.102.45/filesys/spider/pages/asset/spready/css/bd998-5708.css">
        <script type="text/javascript" src="http://39.106.102.45/filesys/spider/pages/asset/spready/js/bm.js"></script>
        <script src="http://39.106.102.45/filesys/spider/pages/asset/spready/js/function1.js"></script>
        <script src="http://39.106.102.45/filesys/spider/pages/asset/spready/js/data.city.js" charset="UTF-8"></script>
        <script type="text/javascript" src="http://39.106.102.45/filesys/spider/pages/asset/spready/js/jquery.min.js"></script>
        <script src="http://39.106.102.45/filesys/spider/pages/asset/spready/js/layer.js"></script>
        <script src="http://39.106.102.45/filesys/spider/pages/asset/spready/js/budet.common.js"></script>
        <script src="http://39.106.102.45/filesys/spider/pages/asset/spready/js/linkagesel.min.js"></script>
        ...
        <div style="display: none">
            ...
            <script type="text/javascript" src="http://39.106.102.45/filesys/spider/pages/asset/spready/js/102866.js" async defer></script>
        </div>
    </body>
