        ...
        <div class="jia_logo clearfix fl" style="padding-top: 0px;">
            <div class="logo fl" style="padding-top: 10px;">
                <a target="_top" class="major_pop" tjjj="click_pc_head.logo.jia" tjjj_name="首页logo" href="javascript:;">
                    <img width="121" height="75" alt="梵客家装网首页"
                         src="http://tjasset.acanstudio.com/spread/house/third/pc_logo_fk_1.png"></a>
            </div>
            <div class="fl" style="position: relative;">
                <a href="javascript:;" class="major_pop" tjjj="click_pc_logo.right.link" tjjj_name="暖暖的新家logo">
                    <img width="128" height="94" src="http://tjasset.acanstudio.com/spread/house/third/pc_logo_fk_2.png"
        ...
        <div class="company_list">
            ...
            <div class="flex-viewport" style="overflow: hidden; position: relative;">
                <ul class="slides clearfix"
                    style="width: 2000%; transition-duration: 0s; transform: translate3d(0px, 0px, 0px);">
    ...
    <div class="contr_center">
        ...
        <div class="add_img">
            <div class="add_left">
                <dl>
                    <dt class="fl">
                        <img src="http://fastued3.jia.com/image/tuku/xm_zxbj_n.png" alt=""/>
                    </dt>
                    <dd class="fr">
                        <h5>装修新家花多少钱？</h5>
            ...
            <div class="add_erweim">
                <img src="http://ued.jia.com/image/zixun/stage3/bottom_bj.png" alt=""/>
