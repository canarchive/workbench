...
$cssFiles = [
    'version_1200', 'new_finish', 'new_putin', 'layer_order',
];
$this->params['cssStr'] = $this->render('@common/views/base/_css-js', ['files' => $cssFiles, 'path' => 'spread/house/sj/css/']);
$jsFiles = [
    'jquery-1.9.1', 'comm', 
];
$this->params['jsStr'] = $this->render('@common/views/base/_css-js', ['type' => 'js', 'files' => $jsFiles, 'path' => 'spread/house/sj/js/']);
        ...
        <div class="wrap clearfix">
            <div class="nav_info_right clearfix">
                ...
                <ul class="entry_menu tn_menu clearfix">
                    <!--<li class="myorder">
                        <a class="menu_hd major_pop" href="javascript:;" tjjj="click_pc_top.menu.qjqb" tjjj_name="<?= $this->context->merchantInfo['name']; ?>钱包"><?= Yii::$app->params['siteNameBase']; ?>钱包</a>
                        <b>
                        </b>
    ...
    <div class="wrap">
        <div class="jia_logo clearfix fl" style="padding-top: 0px;">
            <div class="logo fl" style="padding-top: 10px;">
                ...
                <img width="121" height="75" alt="<?= $this->context->merchantInfo['name']; ?>网首页" src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/third/pc_logo_<?= $currentCode; ?>_1.png"></a>
            </div>
            <div class="fl" style="position: relative;">
                <a href="javascript:;" class="major_pop" tjjj="click_pc_logo.right.link" tjjj_name="暖暖的新家logo">
                <img width="128" height="94" src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/third/pc_logo_<?= $currentCode; ?>_2.png" style="display: block;"></a>
            </div>
        </div>
        ...
        <div class="outWrap">
            ...
            <div class="my_Qj">
                <div class="my_Qj_wrap">
                    <p>
                        <em></em>
                        <a class="major_pop" tjjj="click_pc_top.menu.myqj" href="javascript:;" tjjj_name="我的<?= $this->context->merchantInfo['name']; ?>">我的<?= Yii::$app->params['siteNameBase']; ?></a></p>
                    <i>
                    </i>
                </div>
...
<!--<div class="self-introduction">
    <div class="self_box">
        <img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/sj/images/jia_pet36x36.png"><?= $this->context->merchantInfo['name']; ?>网成立于2005年，是国内知名的专注于装修、建材、家居垂直领域的电商平台。</div>
</div>-->
<div class="newput_main">
            ...
            <div class="change_cont">
                <div class="change_item">
                    ...
                    <div class="menu_box">
                        ...
                        <a href="javascript:;" class="putin_btn estimate_offer major_pop" tjjj="click_pc_top_left_bjbtn" tjjj_name="在线装修报价" apply_title="立即预约<?= $this->context->merchantInfo['name']; ?>网装修报价">立即估算报价</a></div>
                        ...
                        <div class="menu_box">
                            ...
                            <!--<div class="form_remember_v2">
                                <span class="rem_box memCheck" id="iagree2">
                                    ...
                                    <input type="checkbox" checked="checked" class="rem_check" name="iagree">我已阅读并且同意<?= $this->context->merchantInfo['name']; ?>网的
        ...
        <div class="topm_among">
            <div class="big_graph">
                <a href="javascript:;" class="major_pop" tjjj="click_pc_top_nndxj" tjjj_name="暖暖的新家">
                    <img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/third/pc_banner_<?= $currentCode; ?>.jpg" /></a>
            </div>
    ...
    <div id="1F" class="member_case clearfix">
        ...
        <ul class="clearfix">
            ...
            <li>
                <a href="javascript:;" class="major_pop" tjjj="click_pc_member_case3" tjjj_name="三房美式风格 3.5万">
...
<div class="company_list">
    ...
    <div id="5F" class="AdPositionId clearfix">
        <a href="javascript:;" class="major_pop ad_baojia" tjjj="click_pc_Ad_left" tjjj_name="获取报价" apply_title="立即预约<?= $this->context->merchantInfo['name']; ?>网装修报价">
    ...
    <div class="technology_safeguard clearfix">
        ...
        <div id="9F" class="qijia_baozhang">
            <h2 class="column_title">
                <span><?= $this->context->merchantInfo['name']; ?>保障</span></h2>
            <div class="safeguard_cont">
                ...
                <div class="terrace_referral jiabg">
                    <h3>为什么选择<?= $this->context->merchantInfo['name']; ?>？
                        <img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/sj/images/fw_terrace.png" /></h3>
                    <p>1.<?= $this->context->merchantInfo['name']; ?>致力于让更多的网友体验到实实在在的装修体验</p>
                    <p>2.<?= $this->context->merchantInfo['name']; ?>真正的建立起了业主和装修公司、材料商家互通的网上桥梁。</p>
                    <p>3.<?= $this->context->merchantInfo['name']; ?>已成为广大业主装修青睐的装修综合门户网站</p>
                </div>
                <div class="terrace_referral shield">
                    <h3><?= $this->context->merchantInfo['name']; ?>网优质施工队认证标准
                        <img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/sj/images/jia_QA.png" /></h3>
                    <p>1.必须是通过审核在<?= $this->context->merchantInfo['name']; ?>网入住的商家所属的施工队才有资格申请认证优质施工队。</p>
                    <p>2.优质施工队必须参加每次<?= $this->context->merchantInfo['name']; ?>网主办的施工队长培训，并经过考核。</p>
...
<script type="text/javascript">//滚动
    ...
    var order_success = '<div class="layer_order_v2 layer_anim" style="display:none" id="sucess">' + '      <div class="layer_title_v2 apply_success"><i class="ok"></i>恭喜您预约成功！</div>' + '      <div class="layer_content_v3">' + '        <p class="p_green">扫一扫，关注<?= $this->context->merchantInfo['name']; ?>官方微信号</p>' + '        <div class="planar_code"><img src="http://fastued3.jia.com/image/zhuangxiu/new_finish_v2/pc_jiazx.jpg" width="232" height="232" id="qcode"></div>' + '        <p class="stay_cul stor_cul">“您还可以在微信上找到更多服务”</p>' + '      </div>' + '      <a href="javascript:;" class="layer_setwin layer_anim_close" close_tag="success"></a>' + '   </div>';
    ...
    function ex_affect($obj) {
        ...
        if (tjjj.indexOf("5F_") != -1 || tjjj.indexOf("6F_") != -1 || tjjj.indexOf("7F_fuwu_") != -1 || tjjj == "free_jl") {
            $(".apply_title").text("申请免费体验<?= $this->context->merchantInfo['name']; ?>服务");
            ...
            if (tjjj.indexOf("7F_image_") != -1) {
                $(".apply_title").text("申请体验<?= $this->context->merchantInfo['name']; ?>480道工艺");
                $(".lead_num").html("今日已有<span class='day_number'>6867</span>用户申请体验");
    ...
    function verify_order(obj) {
        ...
        if (_this.find('.seet_submit').length > 0) {
            ...
            var arr = ['请输入姓名', '请输入手机号码', '请输入正确的手机号码', '请填写验证码', '请勾选已阅读并且同意<?= $this->context->merchantInfo['name']; ?>网的用户协议'];
