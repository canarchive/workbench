...
Yii::$app->params['tdkInfos']['title'] =  '霍尔果斯企业核名系统';
...
<div class="res-container">
    <div class="review-title">
        <img src="<?= Yii::getAlias('@asseturl'); ?>/spread/snew/hegs/img/hegs.png" alt="" class="review-title-chn">
		<!--<img src="<?= Yii::getAlias('@asseturl'); ?>/spread/snew/hegs/img/hegs_ext.png" alt="" class="review-title-en">-->
    </div>
