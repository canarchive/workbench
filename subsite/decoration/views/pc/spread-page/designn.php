                ...
                <div class="change_tab">
                    <ul class="clearfix">
                        ...
                        <li>
                            ...
                            <img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/sj/images/hot.png">
                        </li>
                    </ul>
                </div>
        ...
        <div class="scheme_handpick clearfix">
            <div class="handpick_item delpd_t delpd_l">
                <a href="javascript:;" class="major_pop item_img" tjjj="click_pc_1F_image_01">
                    <img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/sj/images/scheme_01.jpg"
                ...
                <ul class="swiper-wrapper clearfix">
                    <li class="swiper-slide">
                        <a href="javascript:;" class="major_pop" shop_id="5124263" tjjj="click_pc_3F_logo_2"
                           tjjj_name="<?= $merchantInfo['name']; ?>"><img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/third/fk.jpg"
                                                 draggable="false"></a>
                    ...
                    <li class="swiper-slide">
                        <a href="javascript:;" class="major_pop" shop_id="215226319" tjjj="click_pc_3F_logo_0"
                           tjjj_name="今朝装饰"><img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/sj/images/13568499.jpg"
                                                 draggable="false"></a>
                    ...
                    <li class="swiper-slide">
                        <a href="javascript:;" class="major_pop" shop_id="215227639" tjjj="click_pc_3F_logo_5"
                           tjjj_name="六艺轩装饰"><img
                                src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/sj/images/14865201.jpg"
                                draggable="false"></a>
                    ...
                    <li class="swiper-slide">
                        <a href="javascript:;" class="major_pop" shop_id="5124887" tjjj="click_pc_3F_logo_3"
                           tjjj_name="苏技创意装饰"><img
                                src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/sj/images/10774247.jpg"
                                draggable="false"></a>
                    ...
                    <li class="swiper-slide">
                        <a href="javascript:;" class="major_pop" shop_id="215229201" tjjj="click_pc_3F_logo_4"
                           tjjj_name="多彩饰家装饰"><img
                                src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/sj/images/17391458.jpg"
                                draggable="false"></a>
                    ...
                    <li class="swiper-slide">
                        <a href="javascript:;" class="major_pop" shop_id="5124840" tjjj="click_pc_3F_logo_6"
                           tjjj_name="我爱我家装饰"><img
                                src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/sj/images/13032543.jpg"
                                draggable="false"></a>
                    ...
                    <li class="swiper-slide">
                        <a href="javascript:;" class="major_pop" shop_id="215228567" tjjj="click_pc_3F_logo_7"
                           tjjj_name="速美超级家"><img
                                src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/sj/images/15900725.jpg"
                                draggable="false"></a>
                    ...
                    <li class="swiper-slide">
                        <a href="javascript:;" class="major_pop" shop_id="5124480" tjjj="click_pc_3F_logo_8"
                           tjjj_name="合建装饰"><img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/sj/images/9556113.jpg"
                                                 draggable="false"></a>
                    ...
                    <li class="swiper-slide">
                        <a href="javascript:;" class="major_pop" shop_id="215226853" tjjj="click_pc_3F_logo_9"
                           tjjj_name="合为国际别墅装饰"><img
                                src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/sj/images/14199418.jpg"
                                draggable="false"></a>
...
//选择户型
$('.menu_box').on('click','.p_li',function(){
    $this=$(this);
    $this.children('.norms_se').show();
})
$('.norms_se').on('click','li',function(){
    $this=$(this);
    var a=$.trim($this.text());
    $this.closest('.p_li').find('.quote_select').val(a);
