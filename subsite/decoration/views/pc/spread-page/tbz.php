...
$cssFiles = [
    'new_global', 'toolbar_css', 'zxbjV2',
    'zxbj_new_two', 'zxbj_n_alink',
];
...
.header_top_right ul li a.nav_fzlink {
    color: #333;
    background: url("<?= Yii::getAlias('@asseturl'); ?>/spread/house/searchbackground.png") left no-repeat;
}
</style>
...
<div class="toolbar_header_top">
    <div class="toolbar_header_center">
        <div class="header_top_right toolbar_header_center_right">
            <ul>
                <li>
                <a class="nav_fzlink" href="<?= $urls['index'] . '/shanghai/'; ?>" >上海</a></li>
            </ul>
        </div>
        <div class="toolbar_header_center_left">
            <ul class="clear">
                <li>
                    <a class="nav_fzlink link_to8to" href="<?= $urls['index']; ?>" class="link_to8to">
                        <em href="<?= $urls['index']; ?>" class="toolbar_log"></em><span>兔班长装修网</span>
                    </a>
                </li>
                <li>
    ...
    <div class="footer" id="footerHeight">
        <div class="footer_bottom">
            <div class="footer_bottom_container">
                <div class="fbc_menu">
                    <ul>
                        <li><a hidefocus="" href="<?= $urls['desc']; ?>" rel="nofollow">关于我们</a><span></span></li>
                        <li><a hidefocus="" href="<?= $urls['friendlink']; ?>" rel="nofollow">友情链接</a><span></span></li>
                        <li><a hidefocus="" href="<?= $urls['guestbook']; ?>" rel="nofollow">意见反馈</a><span></span></li>
                        <li><a hidefocus="" href="<?= $urls['statement']; ?>" rel="nofollow">法律声明</a><span></span></li>
                        <li><a hidefocus="" href="<?= $urls['contactus']; ?>" rel="nofollow">联系我们</a><span></span></li>
                    </ul>
                </div>
                <div class="fbc_copyright">免责声明：本网站部分内容由用户自行上传，如权利人发现存在误传其作品情形，请及时与本站联系。</div>
                <div class="fbc_copyright"><?= $this->context->currentSiteInfo['copy']; ?></div>
                <div class="fbc_copyright">地址：北京市昌平区科星西路106号楼407室</div>
                <div class="fbc_icp">兔班长装修网(隶属北京维纳亚科技有限公司）
                    <a href="javascript:void(0);" target="_blank" rel="nofollow"><?= $this->context->currentSiteInfo['icp']; ?></a>
                </div>
            </div>
        </div>
    </div>
