...
<div class="quote_header ">
    <a href="">
        <img class="lf" src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/third/quote/yzf.png" alt=""/>
    </a>
    <ul class="">
        <li>
            <i class="i1"></i>
...
<script src="<?= Yii::getAlias('@assetself'); ?>/rabbithouse/webrabbit/web/myjs/city.js"></script>
<script>
