...
Yii::$app->params['tdkInfos']['title'] =  '装修报价-北京装修报价单_北京装修预算表_北京装修到底需要多少钱-兔班长装修网';
Yii::$app->params['tdkInfos']['keyword'] = '装修报价，环保装修,环保家装,家装团购';
Yii::$app->params['tdkInfos']['description'] = '兔班长装修网装修报价频道为您收集整理了大量2017北京装修报价单，北京装修预算表，北京装修到底需要多少钱，让您家装修更省钱！';
?>
<!--[if lt IE 9]>
...
<div class="toolbar_header_top">
    <div class="toolbar_header_center">
        <div class="header_top_right toolbar_header_center_right">
            <ul>
                <li>
                <a class="nav_fzlink" href="<?= $urls['index']; ?>" >返回官网首页</a></li>
            </ul>
        </div>
    ...
    <div class="footer" id="footerHeight">
        <div class="footer_bottom">
            <div class="footer_bottom_container">
                ...
                <div class="fbc_copyright"><?= $this->context->copyStr; ?></div>
                <div class="fbc_copyright">地址：北京市昌平区科星西路106号楼407室</div>
                <div class="fbc_icp">兔班长装修网(隶属北京维纳亚科技有限公司）
                    <a href="javascript:void(0);" target="_blank" rel="nofollow"><?= $this->context->icpStr; ?></a>
                </div>
            </div>
        </div>
    </div>
