        ...
        <div class="drawer-main drawer-default">
            <nav class="drawer-nav" role="navigation">
                <ul class="drawer-nav-list">
                    <li><a href="http://m.imeizhaike.com/index_m.html">首 页</a></li>
                    <li><a href="http://m.imeizhaike.com/outfits618_m.html">整装套餐</a></li>
                    <li><a href="http://m.imeizhaike.com/material_m.html">主材套餐</a></li>
                    <li><a href="http://m.imeizhaike.com/newhouse338_m.html">施工套餐</a></li>
                    <li><a href="http://m.imeizhaike.com/design_master_m.html">大咖设计</a></li>
...
<section class="select-planform">
  ...
  <figure class="hide-status"> <img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/mzk/m/images/pic_mxc_02.jpg" /> </figure>
  <figure class="hide-status"> <a href="#signup"><img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/mzk/m/images/pic_mxc_04.jpg" /> </a></figure>
  <figure class="hide-status"> <a href="#signup"><img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/mzk/m/images/pic_mxc_06.jpg" /> </a></figure>
