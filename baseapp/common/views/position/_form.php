...
<div class="menu-form">
    ...
    <?= FileUploadUI::widget([
        ...
        'url' => Yii::getAlias('@shopurl') . "/upload/position/picture.html?id={$model->id}",
		'gallery' => true,
        'fieldOptions' => [
    ...
    <?= FileUploadUI::widget([
        ...
        'url' => Yii::getAlias('@shopurl') . "/upload/position/picture_mobile.html?id={$model->id}",
		'gallery' => true,
        'fieldOptions' => [
    ...
    <?= FileUploadUI::widget([
        ...
        'url' => Yii::getAlias('@shopurl') . "/upload/position/picture_ext.html?id={$model->id}",
		'gallery' => true,
        'fieldOptions' => [
